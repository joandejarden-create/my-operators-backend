/**
 * Old Home Boot Guard (v20260730d)
 * Path-gated to /old-home. Same critical CSS/JS as 30b + testimonials v20260730b.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607304) return;
    window.__ohBootGuard = 202607304;
