/**
 * Old Home Boot Guard (v20260730j)
 * Path-gated to /old-home. Same critical CSS/JS as 30b + testimonials v20260730g.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607310) return;
    window.__ohBootGuard = 202607310;
    ...
    [
      ...
      "6a6babd4705000d63967517f_dealality-old-home-testimonials.v20260730g.js",
    ].forEach(function (f) {
