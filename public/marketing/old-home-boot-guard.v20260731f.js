/**
 * Old Home Boot Guard (v20260731f)
 * Path-gated to /old-home. Same as 31d + loads hero scroll cue v20260731b (in-flow under CTAs).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607315) return;
    window.__ohBootGuard = 202607315;
    ...
    [
      ...
      "6a6c872c86d8db3bd17962d7_dealality-old-home-hero-scroll-cue.v20260731b.js",
    ].forEach(function (f) {
      ...
      if (f.indexOf("hero-scroll-cue") !== -1) {
        s.setAttribute("data-oh-hero-scroll-cue", "31b");
      }
