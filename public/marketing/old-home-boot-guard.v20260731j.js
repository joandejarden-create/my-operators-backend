/**
 * Old Home Boot Guard (v20260731j)
 * Path-gated to /old-home. Same as 31i + freeform-head w23 + hero-fit 29f
 * (final quiet signal sizes baked into FOUC-critical CSS; no late quiet-w21 jump).
 * Keeps hero scroll cue v20260731e.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607319) return;
    window.__ohBootGuard = 202607319;
    ...
    [
      ...
      "6a6c919f39ff30b40ba1ce1c_dealality-old-home-freeform-head.v20260729w23.css",
      ...
      "6a6c919f1183b11fc03668f6_dealality-old-home-hero-fit.v20260729f.css",
    ].forEach(function (f) {
    ...
    [
      ...
      "6a6c8cc37c15d97b6c31df41_dealality-old-home-hero-scroll-cue.v20260731e.js",
    ].forEach(function (f) {
      ...
      if (f.indexOf("hero-scroll-cue") !== -1) {
        s.setAttribute("data-oh-hero-scroll-cue", "31e");
      }
