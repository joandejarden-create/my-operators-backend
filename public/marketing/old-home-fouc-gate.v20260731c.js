 ...
 *
 * Fixes:
 * - Signals: freeform-head w25 + hero-fit 29h bake final quiet sizes.
 ...
 * - 31c: pin freeform-head w25 + hero-fit 29h.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohFoucGate && window.__ohFoucGate >= 202607313) return;
    window.__ohFoucGate = 202607313;
    ...
    if (!d.getElementById("oh-fouc-gate-style")) {
      ...
      st.textContent =
        ...
        "#fsw-btn-wrap .oh-fsw-btn,#fsw-btn-wrap #fsw-btn,#fsw-demo-link.oh-fsw-demo-btn,#fsw-demo-link{position:relative!important;flex:0 0 auto!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:2.55rem!important;height:2.55rem!important;max-height:2.55rem!important;padding:.62rem 1.1rem!important;margin:0!important;border-radius:999px!important;box-sizing:border-box!important;font-size:16px!important;line-height:1.2!important}" +"html.oh-boot:not(.oh-ready) #oh-hero-scroll-cue,html.oh-boot:not(.oh-ready) #oh-hero-scroll-cue.oh-hero-scroll-cue{opacity:0!important;visibility:hidden!important;pointer-events:none!important;animation:none!important;transition:none!important}" +"#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:.75rem!important}" +"@media(max-height:900px) and (min-width:961px){#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:.55rem!important}}" +"@media(max-height:800px) and (min-width:961px){#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:.4rem!important}}" +"@media(min-width:1200px) and (min-height:901px){#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:clamp(1.65rem,3.2vh,2.35rem)!important}}" +"@media(min-width:1440px) and (min-height:901px){#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:clamp(2.1rem,3.8vh,2.85rem)!important}}" +"@media(min-width:1600px) and (min-height:950px){#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:clamp(2.45rem,4.2vh,3.25rem)!important}}" +
    ...
    var HEAD_CSS = "6a6c9e130699744243f0d26f_dealality-old-home-freeform-head.v20260729w25.css";
