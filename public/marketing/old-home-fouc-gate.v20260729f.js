 ...
 * v20260729f: hide #fsw-secondary-wrap by default until data-oh-visible="1".
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohFoucGate && window.__ohFoucGate >= 202607296) return;
    window.__ohFoucGate = 202607296;
