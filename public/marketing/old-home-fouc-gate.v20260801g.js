...
(function () {
  try {
    ...
    if (window.__ohFoucGate && window.__ohFoucGate >= 202608017) return;
    window.__ohFoucGate = 202608017;
    ...
    if (!d.getElementById("oh-fouc-gate-style")) {
      ...
      st.textContent =
        ...
        "@media(min-width:1200px) and (min-height:901px){#hero.oh-hero,#hero{padding-top:clamp(3.1rem,6.2vh,4.5rem)!important;padding-bottom:clamp(2.35rem,5.6vh,3.65rem)!important}#hero #hero-inner{transform:none!important}#hero #section-subtitle,#section-subtitle{margin:0 0 .85rem!important}#hero #h1wrap,#hero .oh-h1wrap{margin:0 0 1.35rem!important}#hero #hero-lead,#hero .oh-hero-lead{margin:0 0 1.15rem!important}}" +
        "@media(min-width:1440px) and (min-height:901px){#hero #section-subtitle,#section-subtitle{margin:0 0 .95rem!important}#hero #h1wrap,#hero .oh-h1wrap{margin:0 0 1.55rem!important}#hero #hero-lead,#hero .oh-hero-lead{margin:0 0 1.35rem!important}}" +
        ...
        "@media(min-width:1200px) and (min-height:901px){#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:clamp(2rem,3.6vh,2.75rem)!important}}" +
        "@media(min-width:1440px) and (min-height:901px){#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:clamp(2.35rem,4vh,3.1rem)!important}}" +
        "@media(min-width:1600px) and (min-height:950px){#hero #form-subscribe-wrap,#hero .oh-fsw-wrap,#hero #fsw-cta{margin-top:clamp(2.65rem,4.5vh,3.5rem)!important}}" +
    ...
    var HEAD_CSS = "6a6dfebd6d7424a20895415b_dealality-old-home-freeform-head.v20260801c.css";
