/**
 * Old Home Boot Guard (v20260801b)
 * Path-gated to /old-home.
 * Same as 01a + section-type spacing for How We Do It principle callout.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202608012) return;
    window.__ohBootGuard = 202608012;
    ...
    function ensureSectionTypeLock() {
      ...
      if (existing) {
        existing.href = b + SECTION_TYPE_CSS;
        existing.setAttribute("data-oh-section-type", "01a");
      ...
      link.setAttribute("data-oh-section-type", "01a");
    ...
    [
      ...
      "6a6d43e1d8e7832aae6dd9f0_dealality-old-home-faqs.v20260801a.js",
