/**
 * Old Home testimonials carousel (v20260730n)
 ...
 * - Labels top-left into the card (top:39px); wait for DOM so they always appear
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607313) return;
  } catch (ePath) {
    return;
  }
  ...
  function injectCss() {
    ...
    css.textContent = [
      ...
      "position:relative!important;overflow:visible!important;padding-top:58px!important;",
      "align-items:stretch!important;text-align:left!important}",
      "#testimonials-viewport .oh-tt-audience{",
      "position:absolute!important;top:39px!important;left:24px!important;right:auto!important;",
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 202607313;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 202607313) return;
