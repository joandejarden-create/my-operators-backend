 ...
 * v20260731e: drop local lead margin — section-type spacing lock owns it.
 */
(function () {
  "use strict";
  ...
  try {
    ...
    if (window.__ohFaqs >= 202607335) return;
  } catch (ePath) {
    return;
  }
