/**
 * Old Home Manual Process v1.1.5 boot — fetch approved HTML, then load draw JS.
 * Companion to old-home-manual-process.v20260731h.css + v20260731e.html
 * Closing CTA: Connected Process box layout (left copy + right button).
 */
(function () {
  var HTML_URL =
    "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6d0f964e64ff8c5250f4f4_old-home-manual-process.v20260731e.html";
  var JS_URL =
    "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6cd9140230e8c779bd70c9_old-home-manual-process.v20260731a.js";
  var FONT_HREF =
    "https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@700;800&display=swap";
  ...
  function boot() {
    ...
    ensureFonts();
    fetch(HTML_URL, { credentials: "omit", cache: "force-cache" })
      .then(function (res) {
