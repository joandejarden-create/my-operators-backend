/**
 * Dealality marketing nav width lock (v20260801b)
...
(function () {
  ...
  try {
    ...
    if (window.__dcMktNavWidth && window.__dcMktNavWidth >= 202608012) return;
    window.__dcMktNavWidth = 202608012;

    var STYLE_ID = "dc-mkt-nav-width-01b";
