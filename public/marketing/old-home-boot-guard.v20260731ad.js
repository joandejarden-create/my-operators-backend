/**
 * Old Home Boot Guard (v20260731ad)
 * Path-gated to /old-home.
 * Same as 31ac + section type lock b (higher specificity for How We Do It).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607338) return;
    window.__ohBootGuard = 202607338;
    ...
    [
      ...
      "6a6d14a48573790a5f279096_dealality-old-home-faqs.v20260731b.js",
