/**
 * Old Home Boot Guard (v20260731af)
 * Path-gated to /old-home.
 * Same as 31ae + FAQs v20260731d (answer indent under question text).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607340) return;
    window.__ohBootGuard = 202607340;
    ...
    [
      ...
      "6a6d33abd3093f4cfafd1308_dealality-old-home-faqs.v20260731d.js",
