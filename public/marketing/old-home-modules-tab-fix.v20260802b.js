/**
 * Old Home — Benefits outcomes-only + Spanish eyebrows (v20260802b)
...
(function () {
  try {
    ...
    if (window.__ohModulesTabs >= 202608022) return;
    window.__ohModulesTabs = 202608022;
    ...
    var STYLE_ID = "oh-modules-tabs-02b";
    ...
    function apply() {
      ...
      if (badge && badge.getAttribute("data-oh-benefits") !== "02b") {
        badge.setAttribute("data-oh-benefits", "02b");
