/**
 * Old Home testimonials carousel (v20260730f)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607306) return;
    window.__ohTestimonials = 202607306;
  } catch (ePath) {
    return;
  }
  ...
  function injectCss() {
    ...
    css.textContent = [
      "#testimonials-viewport article[data-oh-audience]{padding-top:22px!important;align-items:stretch!important;text-align:left!important}",
