/**
 * Old Home Boot Guard (v20260730h)
 * Path-gated to /old-home. Same critical CSS/JS as 30b + testimonials v20260730e.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607308) return;
    window.__ohBootGuard = 202607308;
    ...
    [
      ...
      "6a6baa3f3dd719b0d3f2e838_dealality-old-home-testimonials.v20260730e.js",
    ].forEach(function (f) {
