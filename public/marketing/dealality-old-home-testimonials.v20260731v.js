/**
 * Old Home testimonials carousel (v20260731v)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607321) return;
  } catch (ePath) {
    return;
  }
  ...
  var JUSTIN =
    "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6c9825c99e535a91d6320c_justin-boutwell.jpg";
  var JUSTIN_ALT = "Justin Boutwell, Asset Manager";
  var GUSTAVO =
    "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6cab2542c722b527c9de11_gustavo-sarago-avatar.v20260731a.jpg";
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 202607321;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 202607321) return;
