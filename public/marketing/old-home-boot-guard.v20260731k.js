/**
 * Old Home Boot Guard (v20260731k)
 * Path-gated to /old-home. Same as 31i + freeform-head w24 + hero-fit 29g
 * (final quiet signal sizes baked into FOUC-critical CSS; no late quiet-w21 jump).
 * Keeps hero scroll cue v20260731f + globe v202607308.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607320) return;
    window.__ohBootGuard = 202607320;
