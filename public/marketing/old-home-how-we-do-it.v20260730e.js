/**
 * Old Home — How We Do It document-flow process story (v20260730e)
...
(function () {
  try {
    ...
    if (window.__ohHowWeDoIt >= 202607308) return;
    window.__ohHowWeDoIt = 202607308;
    var IMG_BRAND =
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "30e");
        return;
      }
      if (document.querySelector('link[data-oh-how="30e"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "30e");
