/**
 * Old Home — compress hero to first viewport + overview re-open link behavior (v20260729c).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohHeroFitBoot && window.__ohHeroFitBoot >= 202607293) return;
    window.__ohHeroFitBoot = 202607293;

    var base = "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/";
    var cssHref =
      base + "6a6a5be1b239faf73c7e267f_dealality-old-home-hero-fit.v20260729c.css";
    var jsHref =
      base +
    ...
    if (!document.querySelector('link[data-oh-hero-fit="1"]')) {
      ...
      if (existing && existing.href && existing.href.indexOf("v20260729c") === -1) {
