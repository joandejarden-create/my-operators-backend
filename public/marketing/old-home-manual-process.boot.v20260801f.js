/**
 * Old Home Manual Process v1.1.30 boot — section HTML is inlined in the HtmlEmbed
 * so it paints with the page (no fetch / no Loading host). This boot only:
 * fonts → bind demo CTA → load draw JS.
 * Companion: v20260801f10.css + inline HTML + v20260801f10.js (draw).
 */
(function () {
  var JS_URL =
    "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6d61dd154050775498d217_old-home-manual-process.v20260801f10.js";
  var FONT_HREF =
