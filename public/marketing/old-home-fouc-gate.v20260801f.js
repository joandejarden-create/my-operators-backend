...
(function () {
  try {
    ...
    if (window.__ohFoucGate && window.__ohFoucGate >= 202608016) return;
    window.__ohFoucGate = 202608016;
    ...
    if (!d.getElementById("oh-fouc-gate-style")) {
      ...
      st.textContent =
        ...
        /* Explore CTA = Connected Process primary; beat site-head #hero #fsw-btn 2.55rem lock */
        "#hero #fsw-btn,#hero #fsw-btn.oh-fsw-btn,#fsw-btn-wrap .oh-fsw-btn,#fsw-btn-wrap #fsw-btn," +
        "#fsw-btn,#fsw-btn.oh-fsw-btn{position:relative!important;flex:0 0 auto!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:40px!important;height:auto!important;max-height:none!important;padding:0 14px!important;margin:0!important;border-radius:10px!important;box-sizing:border-box!important;font-size:.86rem!important;font-weight:700!important;line-height:1.2!important;background:#6C72FF!important;background-image:none!important;color:#fff!important;box-shadow:none!important;border:0!important;font-family:\"Plus Jakarta Sans\",\"Inter Tight\",system-ui,sans-serif!important}" +
        "#hero #fsw-demo-link,#fsw-demo-link.oh-fsw-demo-btn,#fsw-demo-link{position:relative!important;flex:0 0 auto!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:2.55rem!important;height:2.55rem!important;max-height:2.55rem!important;padding:.62rem 1.1rem!important;margin:0!important;border-radius:999px!important;box-sizing:border-box!important;font-size:16px!important;line-height:1.2!important}" +
        ...
        "@media(min-width:1200px) and (min-height:901px){#hero.oh-hero,#hero{padding-top:clamp(2.85rem,5.8vh,4.1rem)!important;padding-bottom:clamp(2.15rem,5.2vh,3.35rem)!important}#hero #hero-inner{transform:none!important}#hero #section-subtitle,#section-subtitle{margin:0 0 .7rem!important}#hero #h1wrap,#hero .oh-h1wrap{margin:0 0 .85rem!important}#hero #hero-lead,#hero .oh-hero-lead{margin:0 0 .85rem!important}}" +
    ...
    var HEAD_CSS = "6a6df18d8a036759f9164a80_dealality-old-home-freeform-head.v20260801b.css";
