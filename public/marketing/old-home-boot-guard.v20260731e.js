/**
 * Old Home Boot Guard (v20260731e)
 * Path-gated to /old-home. Same as 31d + loads hero scroll cue v20260731a.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607314) return;
    window.__ohBootGuard = 202607314;
    ...
    [
      ...
      "6a6c7c061a41d684c3597464_dealality-old-home-hero-scroll-cue.v20260731a.js",
    ].forEach(function (f) {
      ...
      if (f.indexOf("hero-scroll-cue") !== -1) {
        s.setAttribute("data-oh-hero-scroll-cue", "31a");
      }
