/**
 * Old Home — Benefits outcomes-only (v20260801a)
 * Path-gated to / and /old-home (post cutover).
...
(function () {
  try {
    ...
    if (window.__ohModulesTabs >= 202608011) return;
    window.__ohModulesTabs = 202608011;
    ...
    var STYLE_ID = "oh-modules-tabs-01a";
    ...
    function apply() {
      ...
      if (badge && badge.getAttribute("data-oh-benefits") !== "01a") {
        badge.setAttribute("data-oh-benefits", "01a");
        badge.removeAttribute("role");
        badge.removeAttribute("aria-label");
        badge.innerHTML =
          '<span id="modules-badge-left">Benefits</span>' +
          '<span id="modules-badge-right">What Owners Gain</span>';
      } else if (t1) {
        t1.setAttribute("aria-selected", "true");
        t1.setAttribute("tabindex", "-1");
        t1.textContent = "Benefits";
      }

      if (typeof console !== "undefined" && console.info) {
        console.info("[oh-modules-tabs]", "outcomes-only");
      }
    }
