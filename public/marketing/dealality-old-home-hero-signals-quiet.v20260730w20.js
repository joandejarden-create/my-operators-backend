(function () {
  ...
  var prev = document.getElementById("oh-hero-signals-quiet-w19");
  if (prev) prev.remove();
  var prev18 = document.getElementById("oh-hero-signals-quiet-w18");
  if (prev18) prev18.remove();
  if (document.getElementById("oh-hero-signals-quiet-w20")) return;
  var style = document.createElement("style");
  style.id = "oh-hero-signals-quiet-w20";
  style.textContent = [
    "/* Hero before/after value strip - quiet equal columns, larger type (w20) */",
    ...
    '#hs-pos-label,#hs-neg-label,#hero #hs-pos-label,#hero #hs-neg-label{margin:0 0 .2rem!important;font-family:"Inter Tight","Plus Jakarta Sans",system-ui,sans-serif!important;font-size:.8rem!important;font-weight:600!important;letter-spacing:-.015em!important;text-transform:none!important;line-height:1.2!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}',
    ...
    "#hero-signals-pos > span::before,#hero-signals-neg > span::before,#hero #hero-signals-pos > span::before,#hero #hero-signals-neg > span::before{display:inline-block!important;width:.8rem!important;flex:0 0 .8rem!important;font-weight:600!important;font-size:.88rem!important;line-height:1!important;opacity:.85!important}",
