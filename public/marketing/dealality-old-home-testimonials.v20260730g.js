/**
 * Old Home testimonials carousel (v20260730g)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607307) return;
    window.__ohTestimonials = 202607307;
  } catch (ePath) {
    return;
  }
  ...
  function injectCss() {
    ...
    css.textContent = [
      "#testimonials-viewport article[data-oh-audience]{padding-top:34px!important;align-items:stretch!important;text-align:left!important}",
      ...
      "margin:4px 0 10px!important;padding:0!important;border:0!important;background:transparent!important;",
