 ...
 * v20260731d: indent answers to align with question text (after the number).
 */
(function () {
  "use strict";
  ...
  try {
    ...
    if (window.__ohFaqs >= 202607334) return;
  } catch (ePath) {
    return;
  }
