/**
 * Old Home Boot Guard (v20260731ag)
 * Path-gated to /old-home.
 * Same as 31af + section-type c (unified eyebrow/H2/lead spacing) + FAQs e.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607341) return;
    window.__ohBootGuard = 202607341;
    ...
    var SECTION_TYPE_CSS =
      "6a6d363480964798e83fbab0_dealality-old-home-section-type.v20260731c.css";
    function ensureSectionTypeLock() {
      ...
      link.setAttribute("data-oh-section-type", "31c");
    ...
    [
      ...
      "6a6d3634afd9f0ec32e97a5a_dealality-old-home-faqs.v20260731e.js",
