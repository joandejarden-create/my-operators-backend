...
(function () {
  try {
    ...
    if (window.__ohNavCleanup && window.__ohNavCleanup >= 202607304) return;
    window.__ohNavCleanup = 202607304;
    ...
    function injectStyles() {
      if (document.getElementById("oh-nav-cleanup-30d")) return;
      var style = document.createElement("style");
      style.id = "oh-nav-cleanup-30d";
      style.textContent = [
