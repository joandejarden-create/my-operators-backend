/**
 * Old Home Boot Guard (v20260731x)
 * Path-gated to /old-home. Same as 31w + testimonials v20260731ac (Justin Boutwell quote update).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607332) return;
    window.__ohBootGuard = 202607332;
    ...
    [
      ...
      "6a6d012e6090178c80db722f_dealality-old-home-testimonials.v20260731ac.js",
