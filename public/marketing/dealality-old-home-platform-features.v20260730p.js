/**
 * Old Home — Features image-overlay tiles (v20260730p)
 ...
 * Owner-Controlled Process, Structured Deal Responses, and Deal Readiness use cropped app screenshots.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohPlatformFeaturesTiles >= 202607315) return;
    window.__ohPlatformFeaturesTiles = 202607315;

    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b6d45c18400140983a75d_dealality-old-home-platform-features.v20260730o.css";
    ...
    var IMG_READINESS =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b71962f5665793920cc2f_dealality-old-home-feature-deal-readiness.v20260730p.png";
    ...
    var TILES = [
      ...
      },
      {
        ...
        image: IMG_READINESS,
        imageAlt:
          "Brand Alignment Snapshot cover for Panama City Mixed-Use Hotel Component deal readiness review",
      },
      {
        id: 3,
        icon: "SM",
    ...
    function ensureCss() {
      ...
      if (document.querySelector('link[data-oh-pf="30p"]')) return;
    ...
    function apply() {
      ...
      if (!grid) return;
      if (grid.getAttribute("data-oh-pf-tiles") === "30p") return;
      grid.innerHTML = TILES.map(cardHtml).join("");
      grid.setAttribute("data-oh-pf-tiles", "30p");
    }
