/**
 * Old Home testimonials carousel (v20260802d)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 2026080204) return;
  } catch (ePath) {
    return;
  }
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 2026080204;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 2026080204) return;
