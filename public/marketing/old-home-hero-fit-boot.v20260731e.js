/**
 * Old Home — laptop-tight hero fit + wide/tall breathing room (v20260731e).
 * Loads hero-fit CSS only. PVL is owned by boot-guard (singleton v20260731b).
 * v20260731e: pin hero-fit 29g (CTA sizes locked to 2.55rem; no tall-viewport grow flash).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohHeroFitBoot && window.__ohHeroFitBoot >= 202607314) return;
    window.__ohHeroFitBoot = 202607314;

    var base = "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/";
    var cssHref =
      base + "6a6c95eb01ce84464ec40b67_dealality-old-home-hero-fit.v20260729g.css";
    ...
    if (!existing) {
      ...
      if (existing.href && existing.href.indexOf("v20260729g") === -1) {
