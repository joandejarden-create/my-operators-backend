/**
 * Old Home section order (v20260730h)
 * Path-gated to /old-home.
 * Moves Perspectives above the final CTA / footer and reorders
 * the main story into a clearer problem → process → outcomes → product flow.
 */
(function () {
  try {
    var path = (window.location && window.location.pathname) || "";
    if (path !== "/old-home") return;
    if (window.__ohSectionOrder === 202607310) return;
    window.__ohSectionOrder = 202607310;
