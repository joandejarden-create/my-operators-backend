/**
 * Old Home — Pricing enhance (v20260730g)
 * Path-gated to /old-home.
 * Concrete fee lines, "When you engage" instead of volume row,
 * Pricing nav → #pricing, mobile role picker (one column).
...
(function () {
  ...
  try {
    ...
    if (window.__ohPricingEnhance >= 202607307) return;
    window.__ohPricingEnhance = 202607307;
