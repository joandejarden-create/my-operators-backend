/**
 * Old Home Boot Guard (v20260731ae)
 * Path-gated to /old-home.
 * Same as 31ad + FAQs v20260731c (brand/operator answer platform benefits).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607339) return;
    window.__ohBootGuard = 202607339;
    ...
    var SECTION_TYPE_CSS =
      "6a6d1897fab198de7501bf08_dealality-old-home-section-type.v20260731b.css";
    function ensureSectionTypeLock() {
      ...
      link.setAttribute("data-oh-section-type", "31b");
    ...
    [
      ...
      "6a6d311b3174233c42f00c3e_dealality-old-home-faqs.v20260731c.js",
