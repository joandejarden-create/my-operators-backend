/**
 * Old Home Boot Guard (v20260731h)
 * Path-gated to /old-home. Same as 31g + loads hero scroll cue v20260731d
 * (viewport-bottom pin + V-shaped chevron, no stem).
...
(function () {
  try {
    ...
    [
      ...
      // Absolute in #hero, JS-pinned to visible viewport bottom; V chevron.
      "6a6c891a39ff30b40b9e67c8_dealality-old-home-hero-scroll-cue.v20260731d.js",
    ].forEach(function (f) {
      ...
      if (f.indexOf("hero-scroll-cue") !== -1) {
        s.setAttribute("data-oh-hero-scroll-cue", "31d");
      }
