/**
 * Old Home testimonials carousel (v20260730r)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607317) return;
  } catch (ePath) {
    return;
  }
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 202607317;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 202607317) return;
