/**
 * Old Home Boot Guard (v20260730g)
 * Path-gated to /old-home. Same critical CSS/JS as 30b + testimonials v20260730d.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607307) return;
    window.__ohBootGuard = 202607307;
    ...
    [
      ...
      "6a6ba8de10ec7dc81f8cf0a2_dealality-old-home-testimonials.v20260730d.js",
    ].forEach(function (f) {
