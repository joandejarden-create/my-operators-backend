/**
 * Old Home — How We Do It document-flow process story (v20260730d)
...
(function () {
  try {
    ...
    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6afd2379850e202dc562cd_dealality-old-home-how-we-do-it.v20260730d.css";
    if (window.__ohHowWeDoIt >= 202607305) return;
    window.__ohHowWeDoIt = 202607305;
    var IMG_BRAND =
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "30d");
        return;
      }
      if (document.querySelector('link[data-oh-how="30d"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "30d");
