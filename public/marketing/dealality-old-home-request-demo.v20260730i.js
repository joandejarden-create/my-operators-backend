/**
 * Old Home — Request a Demo (v20260730i)
 ...
 * Hero: Explore + small Request a Demo directly under With/Without cards.
 */
(function () {
  "use strict";
  ...
  try {
    ...
    if (window.__ohRequestDemo >= 202607309) return;
    window.__ohRequestDemo = 202607309;
    ...
    function injectCss() {
      ...
      css.textContent = [
        ...
        "#hero #form-subscribe-wrap,#form-subscribe-wrap.oh-fsw-wrap,#form-subscribe-wrap{width:100%!important;max-width:min(100%,26rem)!important;margin-top:.75rem!important;margin-left:0!important;margin-right:auto!important;align-items:flex-start!important;justify-content:flex-start!important}",
        ...
        "#fsw-btn-wrap.oh-fsw-btn-wrap,#fsw-btn-wrap{position:relative!important;inset:auto!important;display:inline-flex!important;flex-direction:row!important;flex-wrap:nowrap!important;align-items:stretch!important;justify-content:flex-start!important;gap:8px!important;width:auto!important;height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important;margin:0!important}",
        "#fsw-btn-wrap .oh-fsw-btn,#fsw-btn-wrap #fsw-btn{position:relative!important;flex:0 0 auto!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;height:auto!important;min-height:2.55rem!important;line-height:1.2!important;padding:.62rem 1.1rem!important;margin:0!important;border-radius:999px!important;box-sizing:border-box!important}",
        "#fsw-demo-link.oh-fsw-demo-btn,#fsw-demo-link{appearance:none!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;flex:0 0 auto!important;width:auto!important;height:auto!important;min-height:2.55rem!important;max-height:none!important;padding:.62rem 12px!important;margin:0!important;box-sizing:border-box!important;border-radius:10px!important;border:1px solid #d78e2c!important;background:#d78e2c!important;color:#0b1220!important;font-size:12px!important;font-weight:700!important;letter-spacing:-.01em!important;line-height:1.2!important;white-space:nowrap!important;text-decoration:none!important;cursor:pointer!important;box-shadow:0 8px 18px rgba(215,142,44,.28)!important;transition:background .2s ease,border-color .2s ease,filter .15s ease,transform .15s ease!important}",
        "#fsw-demo-link.oh-fsw-demo-btn:hover,#fsw-demo-link:hover{background:#e09a3a!important;border-color:#e09a3a!important;color:#0b1220!important;filter:brightness(1.03)!important;transform:translateY(-1px)!important}",
    ...
    function ensureModal() {
      ...
      if (overlay && overlay.getAttribute("data-oh-demo-ver") === "30i") return overlay;
      if (overlay && overlay.parentNode) {
        try { overlay.parentNode.removeChild(overlay); } catch (_e) {}
      }
      overlay = document.createElement("div");
      overlay.id = "oh-demo-overlay";
      overlay.setAttribute("data-oh-demo-ver", "30i");
