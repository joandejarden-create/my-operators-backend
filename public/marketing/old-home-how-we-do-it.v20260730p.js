/**
 * Old Home — How We Do It compact one-screen process (v20260730p)
...
(function () {
  try {
    ...
    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b5beb9fa9bc24639484dc_dealality-old-home-how-we-do-it.v20260730p.css";
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "30p");
        return;
      }
      if (document.querySelector('link[data-oh-how="30p"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "30p");
    ...
    function mount() {
      ...
      if (existing && existing.getAttribute("data-oh-how") === "30p") return true;
    ...
    function bind(section) {
      ...
      function lockPanelHeight() {
        ...
        // Clear locked height so natural step heights can be measured
      ...
      setActive(0, false);
      scheduleHeightLock();
      // Re-measure after images load (images themselves unchanged)
