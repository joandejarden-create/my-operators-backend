/**
 * Old Home — unify Explore / Opportunity Review CTAs (v20260801b)
...
(function () {
  try {
    ...
    if (window.__ohExploreCta >= 202608012) return;
    window.__ohExploreCta = 202608012;

    var STYLE_ID = "oh-explore-cta-01b";
    ...
    function ensureStyle() {
      ...
      head.appendChild(st);
      var old = document.getElementById("oh-explore-cta-01a");
