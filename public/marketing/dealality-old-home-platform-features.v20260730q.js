/**
 * Old Home — Features image-overlay tiles (v20260730q)
...
(function () {
  try {
    ...
    if (window.__ohPlatformFeaturesTiles >= 202607316) return;
    window.__ohPlatformFeaturesTiles = 202607316;

    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b725824df966e0a2af08b_dealality-old-home-platform-features.v20260730q.css";
    ...
    function ensureCss() {
      ...
      if (document.querySelector('link[data-oh-pf="30q"]')) return;
    ...
    function apply() {
      ...
      if (!grid) return;
      if (grid.getAttribute("data-oh-pf-tiles") === "30q") return;
      grid.innerHTML = TILES.map(cardHtml).join("");
      grid.setAttribute("data-oh-pf-tiles", "30q");
    }
