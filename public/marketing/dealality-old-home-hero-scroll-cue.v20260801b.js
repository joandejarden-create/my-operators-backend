/**
 * Old Home — hero tertiary scroll cue (v20260801b)
...
(function () {
  ...
  try {
    ...
    if (window.__ohHeroScrollCue && window.__ohHeroScrollCue >= 202608012) return;
    window.__ohHeroScrollCue = 202608012;
    ...
    var PAD = 18;
    var NAV_OFFSET = 72;
    /** Extra space under sticky nav so eyebrow sits slightly below the bar. */
    var EYEBROW_BREATH_PX = 20;
    ...
    function injectCss() {
      ...
      css.textContent = [
        "#oh-how-we-do-it{scroll-margin-top:calc(128px + env(safe-area-inset-top,0px))!important}",
