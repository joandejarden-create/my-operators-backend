/**
 * Old Home Boot Guard (v20260801a)
 * Path-gated to /old-home.
 * Same as 31aj + FAQ v20260801a (chevron align + open rotate).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202608011) return;
    window.__ohBootGuard = 202608011;
    ...
    var SECTION_TYPE_CSS =
      "6a6d3d65d4b969173a6efae1_dealality-old-home-section-type.v20260731e.css";
    function ensureSectionTypeLock() {
      ...
      link.setAttribute("data-oh-section-type", "31e");
