/**
 * Old Home Boot Guard (v20260731l)
 * Path-gated to /old-home. Same as 31k + testimonials v20260731t
 * (Justin Boutwell quote; audience labels removed).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607321) return;
    window.__ohBootGuard = 202607321;
    ...
    [
      ...
      "6a6c984ba29502a704125d3d_dealality-old-home-testimonials.v20260731t.js",
