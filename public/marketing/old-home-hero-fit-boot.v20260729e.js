/**
 * Old Home — laptop-tight hero fit + wide/tall breathing room (v20260729e).
...
(function () {
  try {
    ...
    if (window.__ohHeroFitBoot && window.__ohHeroFitBoot >= 202607295) return;
    window.__ohHeroFitBoot = 202607295;
