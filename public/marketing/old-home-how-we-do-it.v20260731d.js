/**
 * Old Home — How We Do It compact one-screen process (v20260731d)
  ...
  try {
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "31d");
        return;
      }
      if (document.querySelector('link[data-oh-how="31d"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "31d");
