/**
 * Old Home — Features image-overlay hover tiles (v20260730g)
...
(function () {
  try {
    ...
    if (window.__ohPlatformFeaturesTiles >= 202607307) return;
    window.__ohPlatformFeaturesTiles = 202607307;

    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b404d3b4663fd2296c160_dealality-old-home-platform-features.v20260730g.css";
    ...
    function ensureCss() {
      ...
      for (i = 0; i < links.length; i++) {
        ...
        links[i].setAttribute("data-oh-pf", "30g");
      }
      if (document.querySelector('link[data-oh-pf="30g"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-pf", "30g");
    ...
    function apply() {
      ...
      if (!grid) return;
      if (grid.getAttribute("data-oh-pf-tiles") === "30g") return;
      grid.innerHTML = TILES.map(cardHtml).join("");
      grid.setAttribute("data-oh-pf-tiles", "30g");
    }
