/**
 * Old Home testimonials carousel (v20260730q)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607316) return;
  } catch (ePath) {
    return;
  }
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 202607316;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 202607316) return;
