/**
 * Old Home Boot Guard (v20260730aa)
 * Path-gated to /old-home. Same critical CSS/JS as 30b + testimonials v20260730s + pricing v20260730f.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607327) return;
    window.__ohBootGuard = 202607327;
