/**
 * Old Home — laptop-tight hero fit + wide/tall breathing room (v20260731f).
 * Loads hero-fit CSS only. PVL is owned by boot-guard (singleton v20260731b).
 * v20260731f: pin hero-fit 29h (CTA stays 2.55rem on short height; margins align w25).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohHeroFitBoot && window.__ohHeroFitBoot >= 202607315) return;
    window.__ohHeroFitBoot = 202607315;

    var base = "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/";
    var cssHref =
      base + "6a6c9e1362368e3a654cf326_dealality-old-home-hero-fit.v20260729h.css";
    ...
    if (!existing) {
      ...
      if (existing.href && existing.href.indexOf("v20260729h") === -1) {
