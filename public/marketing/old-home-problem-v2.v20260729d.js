(function () {
  try {
    ...
    var w20Re = /dealality-old-home-freeform-head\.v20260729w20\.css/i;
    ...
    function pinCss() {
      ...
      document.querySelectorAll('link[rel="stylesheet"]').forEach(function (link) {
        ...
        // OHModulesTabFixW16 (and older boots) re-inject w16 with opacity:0!important
        // which blocks the fragment fade-in animation.
        try {
          link.disabled = true;
