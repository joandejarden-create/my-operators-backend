/**
 * Old Home Boot Guard (v20260730y)
 * Path-gated to /old-home. Same critical CSS/JS as 30b + testimonials v20260730s + pricing v20260730d.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607325) return;
    window.__ohBootGuard = 202607325;
    ...
    [
      ...
      "6a6bccfd7bee90125a8b8117_dealality-old-home-pricing.v20260730d.css",
    ...
    [
      ...
      "6a6bccfd1ab2b68bd29d5677_dealality-old-home-pricing.v20260730d.js",
    ].forEach(function (f) {
