/**
 * Old Home — Features compact Radar/Fee + hover copy (v20260730f)
...
(function () {
  try {
    ...
    if (window.__ohPlatformFeaturesTiles >= 202607306) return;
    window.__ohPlatformFeaturesTiles = 202607306;

    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b3c2785d2f1c40dd6b46b_dealality-old-home-platform-features.v20260730e2.css";
    ...
    function ensureCss() {
      ...
      for (i = 0; i < links.length; i++) {
        ...
        links[i].setAttribute("data-oh-pf", "30f");
      }
      if (document.querySelector('link[data-oh-pf="30f"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-pf", "30f");
    ...
    function apply() {
      ...
      if (!grid) return;
      if (grid.getAttribute("data-oh-pf-tiles") === "30f") return;
      grid.innerHTML = TILES.map(cardHtml).join("");
      grid.setAttribute("data-oh-pf-tiles", "30f");
    }
