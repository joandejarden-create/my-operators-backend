/**
 * Old Home Boot Guard (v20260731o)
 * Path-gated to /old-home. Same as 31n + freeform-head w26 (pure white nav links).
 * Keeps freeform-head w26 + hero-fit 29h + scroll cue 31f + globe 309.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607324) return;
    window.__ohBootGuard = 202607324;
