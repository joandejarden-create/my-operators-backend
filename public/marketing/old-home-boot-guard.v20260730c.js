/**
 * Old Home Boot Guard (v20260730c)
 * Path-gated to /old-home. Critical CSS/JS + globe 308.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607303) return;
    window.__ohBootGuard = 202607303;
