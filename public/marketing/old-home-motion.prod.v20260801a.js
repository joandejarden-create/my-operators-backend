...
(function () {
  ...
  function decorate() {
    ...
    markSequence("testimonials", [
      ...
      qs("#testimonials .oh-testimonial-slide.is-active .oh-testimonial-card").length
        ? qs("#testimonials .oh-testimonial-slide.is-active .oh-testimonial-card")
        : qs("#testimonials .oh-testimonial-card"),
    ]);
    markLift(qs("#testimonials .oh-testimonial-card"));
