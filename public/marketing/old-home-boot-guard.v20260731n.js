/**
 * Old Home Boot Guard (v20260731n)
 * Path-gated to /old-home. Same as 31m + hero restore: freeform w25, hero-fit 29h, globe 309
 * (Justin + Gustavo quotes; audience labels removed).
 * Keeps freeform-head w25 + hero-fit 29h + scroll cue 31f + globe 309.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607323) return;
    window.__ohBootGuard = 202607323;
    ...
    [
      ...
      "6a6c9e130699744243f0d26f_dealality-old-home-freeform-head.v20260729w25.css",
