/**
 * Old Home — Benefits outcomes-only (v20260730e)
...
(function () {
  try {
    ...
    if (window.__ohModulesTabs >= 202607305) return;
    window.__ohModulesTabs = 202607305;
    ...
    var STYLE_ID = "oh-modules-tabs-30e";
    ...
    function apply() {
      ...
      if (badge && badge.getAttribute("data-oh-benefits") !== "30e") {
        badge.setAttribute("data-oh-benefits", "30e");
