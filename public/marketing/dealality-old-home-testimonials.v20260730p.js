/**
 * Old Home testimonials carousel (v20260730p)
 ...
 * - Labels top-left (top:24px), no punch-out / no top accent above label
 * - Second accent line under label, above headshot
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607315) return;
  } catch (ePath) {
    return;
  }
  ...
  function injectCss() {
    ...
    css.textContent = [
      ...
      "#testimonials-viewport article[data-oh-audience]::before{",
      "content:none!important;display:none!important;opacity:0!important;",
      "background:none!important;box-shadow:none!important}",
      "#testimonials-viewport article[data-oh-audience]::after{",
      "content:\"\"!important;display:block!important;position:absolute!important;",
      "left:10%!important;right:10%!important;top:48px!important;height:1px!important;",
      "background:linear-gradient(90deg,transparent,rgba(183,162,252,.9),rgba(139,144,255,.85),transparent)!important;",
      "box-shadow:0 0 14px rgba(139,144,255,.45)!important;opacity:1!important;",
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 202607315;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 202607315) return;
