/**
 * Old Home testimonials carousel (v20260802a)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202608021) return;
  } catch (ePath) {
    return;
  }
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 202608021;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 202608021) return;
