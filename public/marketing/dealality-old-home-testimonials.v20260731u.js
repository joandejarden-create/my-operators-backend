/**
 * Old Home testimonials carousel (v20260731u)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607320) return;
  } catch (ePath) {
    return;
  }
  ...
  var GUSTAVO =
    "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6c98ed86bf5fa7b2f216e7_gustavo-sarago.jpg";
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 202607320;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 202607320) return;
