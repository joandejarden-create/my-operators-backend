/** Opportunity Review form v20260802b — Spanish UI on /es; EN API values preserved. */
(function () {
  "use strict";
  ...
  function pageMarkup() {
    return (
      '<nav class="or-nav" aria-label="' + t("Opportunity review navigation", "Navegación de revisión de oportunidad") + '">' +
      ...
      fieldMarkup("role", t("Role", "Rol"), "text", t("Owner, Developer, Investor, Advisor...", "Propietario, Desarrollador, Inversor, Asesor..."), "organization-title", true) +
      "</div></section>" +
      ...
      "</div></form></div></main>" +
      '<footer class="or-footer">© Dealality · <a href="' + privacyHref() + '">' + t("Privacy", "Privacidad") + '</a></footer>'
    );
  }
