/**
 * Old Home FOUC gate (v20260801j)
 * Path-gated to / and /old-home (homepage cutover). Hides #dc-page until critical CSS applies,
...
(function () {
  try {
    ...
    if (window.__ohFoucGate && window.__ohFoucGate >= 202608020) return;
    window.__ohFoucGate = 202608020;
