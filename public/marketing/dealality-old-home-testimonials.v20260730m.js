/**
 * Old Home testimonials carousel (v20260730m)
 ...
 * - Labels use rotator yellow (#D78E2C), top-left on the card, 10px lower into the card
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607312) return;
    window.__ohTestimonials = 202607312;
  } catch (ePath) {
    return;
  }
  ...
  function injectCss() {
    ...
    css.textContent = [
      ...
      "position:absolute!important;top:-1px!important;left:24px!important;right:auto!important;",
