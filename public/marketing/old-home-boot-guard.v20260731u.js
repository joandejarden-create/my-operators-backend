/**
 * Old Home Boot Guard (v20260731u)
 * Path-gated to /old-home. Same as 31r + testimonials v20260731z (Gustavo clean full-head crop).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607330) return;
    window.__ohBootGuard = 202607330;
    ...
    [
      ...
      "6a6cb07c25a2ce47794f4e08_dealality-old-home-testimonials.v20260731z.js",
