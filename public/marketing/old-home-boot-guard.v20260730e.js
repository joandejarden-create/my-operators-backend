/**
 * Old Home Boot Guard (v20260730e)
 * Path-gated to /old-home. Same as 30d + hero headline rotator.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607305) return;
    window.__ohBootGuard = 202607305;
    ...
    [
      ...
      "6a6afce2bf411005b9fe4088_dealality-old-home-testimonials.v20260730b.js",
      "6a6b2f48c6e91425d2d64c41_old-home-hero-rotator.v20260730g.js",
      "6a6b2db186e4d37d0649debc_old-home-modules-icons.v20260730f.js",
    ].forEach(function (f) {
