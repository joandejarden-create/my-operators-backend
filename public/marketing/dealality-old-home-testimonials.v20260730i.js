/**
 * Old Home testimonials carousel (v20260730i)
 ...
 * - Labels use rotator yellow (#D78E2C) and left-align with quote body
 */
(function () {
  "use strict";
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607308) return;
    window.__ohTestimonials = 202607308;
  } catch (ePath) {
    return;
  }
  ...
  function injectCss() {
    ...
    css.textContent = [
      "#testimonials-viewport article[data-oh-audience]{padding-top:48px!important;align-items:stretch!important;text-align:left!important}",
      "#testimonials-viewport .oh-tt-audience{",
      "display:block!important;align-self:stretch!important;width:100%!important;box-sizing:border-box!important;",
      ...
      "#testimonials-viewport article p:not(.oh-tt-audience){text-align:left!important;align-self:stretch!important;width:100%!important}",
  ...
  var ABOUT_LEAD =
    "Dealality was developed from the realities of hotel brand, operator, development, conversion, and strategic-partner decisions, informed by work with major global brands on growth strategies and the hospitality perspective of senior hospitality advisors.";
