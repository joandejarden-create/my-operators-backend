/**
 * Old Home — Benefits outcomes-only (v20260802a)
...
(function () {
  try {
    ...
    if (window.__ohModulesTabs >= 202608021) return;
    window.__ohModulesTabs = 202608021;
    ...
    var STYLE_ID = "oh-modules-tabs-02a";
    ...
    function apply() {
      ...
      if (badge && badge.getAttribute("data-oh-benefits") !== "02a") {
        badge.setAttribute("data-oh-benefits", "02a");
