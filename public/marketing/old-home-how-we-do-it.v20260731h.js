/**
 * Old Home — How We Do It compact one-screen process (v20260731h)
...
(function () {
  try {
    ...
    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6d1f12df7f3e79b92f22d6_dealality-old-home-how-we-do-it.v20260731d.css";
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "31g");
        return;
      }
      if (document.querySelector('link[data-oh-how="31g"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "31g");
