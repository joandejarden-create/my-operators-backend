 ...
 * v20260729d: pin freeform-head to live SoT v20260729w22 (equal-width With/Without headers).
 *             Keep herofit at live SoT v20260729e (was already correct on 29c CDN).
 *             Platform features pinned to v20260730b equal 3×2 (kills x1/x2 spans).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohFoucGate && window.__ohFoucGate >= 202607294) return;
    window.__ohFoucGate = 202607294;
    ...
    var critical = [
      ...
      // w22 — equal-width With/Without headers (single-line), quiet Proper Case
      ["head", b + "6a6a7cb895b20766ec5595f9_dealality-old-home-freeform-head.v20260729w22.css"],
      ...
      // hero-fit — live SoT v20260729e (laptop-tight + wide/tall breathing room)
      ["herofit", b + "6a6a7598332f85a5833260a6_dealality-old-home-hero-fit.v20260729e.css"],
    ];
