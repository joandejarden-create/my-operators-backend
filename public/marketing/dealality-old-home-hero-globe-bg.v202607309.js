/**
 * Old Home hero — subtle full-bleed 3D globe background (v202607309).
...
(function () {
  ...
  var GLOBE_BUILD = 202607309; // Immediate THREE load; DOM-wait + reclaim retries
  ...
  function ensureThree() {
    if (!threePromise) {
      threePromise = loadScript(THREE_SRC).catch(function (err) {
        threePromise = null;
        throw err;
      });
    }
