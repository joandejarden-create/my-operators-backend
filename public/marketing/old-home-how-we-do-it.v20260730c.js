/**
 * Old Home — How We Do It scroll-led process story (v20260730c)
 * Path-gated to /old-home. Premium product story: sticky nav + large visuals.
...
(function () {
  try {
    ...
    if (window.__ohHowWeDoIt >= 202607303) return;
    window.__ohHowWeDoIt = 202607303;

    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6af20e10fe022fba613616_dealality-old-home-how-we-do-it.v20260730c.css";
    var IMG_BRAND =
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "30c");
        return;
      }
      if (document.querySelector('link[data-oh-how="30c"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "30c");
