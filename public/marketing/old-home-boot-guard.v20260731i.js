/**
 * Old Home Boot Guard (v20260731i)
 * Path-gated to /old-home. Same as 31h + loads hero scroll cue v20260731e
 * (viewport pin via --oh-cue-top; fixes top:auto!important under-fold bug).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607318) return;
    window.__ohBootGuard = 202607318;
