/**
 * Old Home Boot Guard (v20260801e)
 * Path-gated to /old-home.
 * 01e: prioritize hero globe — preload THREE + 512 texture, load globe JS
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202608015) return;
    window.__ohBootGuard = 202608015;
