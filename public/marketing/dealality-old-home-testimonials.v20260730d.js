/**
 * Old Home testimonials carousel (v20260730d)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607304) return;
    window.__ohTestimonials = 202607304;
  } catch (ePath) {
    return;
  }
  ...
  function injectCss() {
    ...
    css.textContent = [
      ...
      "color:#d78e2c!important;font-size:11px!important;font-weight:700!important;letter-spacing:.14em!important;",
