/**
 * Old Home hero — subtle full-bleed 3D globe background (v20260801e).
 * Thin orange square pins; CALA cascade → ease toward Europe → Europe cascade;
 * CALA pins stay visible; ultra-slow spin after.
 * 01e: remove MENA pins (Casablanca, Cairo, Riyadh, Dubai) — Europe-only east edge.
...
(function () {
  ...
  var GLOBE_BUILD = 202608015; // no MENA pins
   ...
   * as the globe turns toward Europe. No Middle East / Maghreb pins.
   */
  var EUROPE_PINS = [
