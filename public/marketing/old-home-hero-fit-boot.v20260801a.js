/**
 * Old Home — laptop-tight hero fit + wide/tall fold-pin CTAs (v20260801a).
...
(function () {
  try {
    ...
    if (window.__ohHeroFitBoot && window.__ohHeroFitBoot >= 202608011) return;
    window.__ohHeroFitBoot = 202608011;

    var base = "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/";
    var cssHref =
      base + "6a6e03fb4f430ec437b05052_dealality-old-home-hero-fit.v20260801a.css";
