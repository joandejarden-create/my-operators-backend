/**
 * Old Home testimonials carousel (v20260731z)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607325) return;
  } catch (ePath) {
    return;
  }
  ...
  var GUSTAVO =
    "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6cb069c8965b52bbf8b033_gustavo-sarago-avatar.v20260731f.jpg";
    ...
    articles.forEach(function (article, i) {
      ...
      if (img) {
        ...
        if (card.name === "Justin Boutwell") {
          ...
          // Full-head asset already has headroom; do not use Justin's 18% face bias.
