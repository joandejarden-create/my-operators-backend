/**
 * Old Home — How We Do It compact one-screen process (v20260730m)
...
(function () {
  try {
    ...
    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b575181f3b977ba20d4fb_dealality-old-home-how-we-do-it.v20260730m.css";
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "30m");
        return;
      }
      if (document.querySelector('link[data-oh-how="30m"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "30m");
