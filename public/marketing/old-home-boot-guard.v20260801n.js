/**
 * Old Home Boot Guard (v20260801n)
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 2026080114) return;
    window.__ohBootGuard = 2026080114;
    ...
    [
      ...
      "6a6e03fbd7734260d3714480_dealality-old-home-freeform-head.v20260801d.css",
      "6a6a95d4c41ba2c194a43045_dealality-old-home-platform-features.v20260730b.css",
      "6a6e03fb4f430ec437b05052_dealality-old-home-hero-fit.v20260801a.css",
    ].forEach(function (f) {
      var l = document.createElement("link");
      l.rel = "stylesheet";
      l.href = b + f;
