/**
 * Old Home Boot Guard (v20260802g)
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 2026080207) return;
    window.__ohBootGuard = 2026080207;
    ...
    [
      "6a6efa016dbeec8fe5ecfbea_dealality-old-home-platform-video-launcher.v20260802a.js",
      "6a6ee8f02e517465ed8d01b0_dealality-old-home-testimonials.v20260802a.js",
      "6a6ee795fbde2ad2134f289f_dealality-old-home-faqs.v20260802a.js",
      "6a6ef5f3f8f8df8c5430afde_dealality-old-home-many-futures-i18n.v20260802b.js",
      ...
      "6a6eeeb407b7741bf50e0cb9_dealality-old-home-hero-scroll-cue.v20260802a.js",
    ].forEach(function (f) {
      var s = document.createElement("script");
      s.defer = true;
      s.src = b + f;
      if (f.indexOf("platform-video-launcher") !== -1 || f.indexOf("PVL_02A") !== -1) {
        s.setAttribute("data-oh-pvl", "02a");
      }
      if (f.indexOf("hero-scroll-cue") !== -1) {
        s.setAttribute("data-oh-hero-scroll-cue", "02a");
      }
      head.appendChild(s);
    });
  } catch (e) {
