/**
 * Old Home testimonials carousel (v20260731ab)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 202607328) return;
  } catch (ePath) {
    return;
  }
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 202607328;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 202607328) return;
