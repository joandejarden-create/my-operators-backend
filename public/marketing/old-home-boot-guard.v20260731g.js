/**
 * Old Home Boot Guard (v20260731g)
 * Path-gated to /old-home. Same as 31f + loads hero scroll cue v20260731c
 * (absolute inside #hero, pinned to visible viewport bottom — not under the fold).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607316) return;
    window.__ohBootGuard = 202607316;
    ...
    [
      ...
      // Absolute in #hero, JS-pinned to visible viewport bottom (not under fold).
      "6a6c88756458c726443fa84b_dealality-old-home-hero-scroll-cue.v20260731c.js",
    ].forEach(function (f) {
      ...
      if (f.indexOf("hero-scroll-cue") !== -1) {
        s.setAttribute("data-oh-hero-scroll-cue", "31c");
      }
