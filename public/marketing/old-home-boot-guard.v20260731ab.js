/**
 * Old Home Boot Guard (v20260731ab)
 * Path-gated to /old-home. Same as 31z + testimonials v20260731ae (Gustavo avatar headroom).
 * Keeps freeform-head w26 + hero-fit 29h + scroll cue 31g + globe 309 + FAQs 31b (combined).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607336) return;
    window.__ohBootGuard = 202607336;
