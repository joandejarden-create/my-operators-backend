/**
 * Old Home — How We Do It compact one-screen process (v20260731a)
...
(function () {
  try {
    ...
    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6c484678ad19640cfbfa16_dealality-old-home-how-we-do-it.v20260731a.css";
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "31a");
        return;
      }
      if (document.querySelector('link[data-oh-how="31b"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "31a");
    ...
    function buildSection() {
      ...
      return (
        ...
        "<div>" +
        "<h3>Meet offline. Stay connected in Dealality.</h3>" +
        "<p>Calls, site visits, and alignment happen between people. Dealality prepares them, tracks them, and keeps the decision record intact.</p>" +
        "</div>" +
