/**
 * Old Home Boot Guard (v20260731s)
 * Path-gated to /old-home. Same as 31r + testimonials v20260731x (Gustavo full-head avatar).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607328) return;
    window.__ohBootGuard = 202607328;
    ...
    [
      ...
      "6a6cae2ff068eefb494fd607_dealality-old-home-testimonials.v20260731x.js",
