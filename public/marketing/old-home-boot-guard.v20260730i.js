/**
 * Old Home Boot Guard (v20260730i)
 * Path-gated to /old-home. Same critical CSS/JS as 30b + testimonials v20260730f.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607309) return;
    window.__ohBootGuard = 202607309;
    ...
    [
      ...
      "6a6bab4d784123fabd4d2571_dealality-old-home-testimonials.v20260730f.js",
    ].forEach(function (f) {
