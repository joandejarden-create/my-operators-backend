/**
 * Old Home Boot Guard (v20260731m)
 * Path-gated to /old-home. Same as 31l + testimonials v20260731u
 * (Justin + Gustavo quotes; audience labels removed).
 * Keeps freeform-head w24 + hero-fit 29g + scroll cue 31f + globe 308.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607322) return;
    window.__ohBootGuard = 202607322;
    ...
    [
      ...
      "6a6c95eb52337f3f47039583_dealality-old-home-freeform-head.v20260729w24.css",
      ...
      "6a6c95eb01ce84464ec40b67_dealality-old-home-hero-fit.v20260729g.css",
    ].forEach(function (f) {
    ...
    [
      "6a6c95eb1dd43da2d6899c4e_dealality-old-home-hero-globe-bg.v202607308.js",
      "6a6c73926d8f50645f9ae3fd_dealality-old-home-platform-video-launcher.v20260731b.js",
      "6a6c990b1dd43da2d68ab98f_dealality-old-home-testimonials.v20260731u.js",
      ...
      "6a6c95eb1dd43da2d6899c63_dealality-old-home-hero-scroll-cue.v20260731f.js",
    ].forEach(function (f) {
      ...
      if (f.indexOf("hero-scroll-cue") !== -1) {
        s.setAttribute("data-oh-hero-scroll-cue", "31f");
      }
