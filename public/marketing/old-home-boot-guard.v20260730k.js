/**
 * Old Home Boot Guard (v20260730k)
 * Path-gated to /old-home. Same critical CSS/JS as 30b + testimonials v20260730h.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607311) return;
    window.__ohBootGuard = 202607311;
    ...
    [
      ...
      "6a6bac607c96daafeea5e8c8_dealality-old-home-testimonials.v20260730h.js",
    ].forEach(function (f) {
