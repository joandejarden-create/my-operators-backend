/**
 * Old Home Boot Guard (v20260731t)
 * Path-gated to /old-home. Same as 31r + testimonials v20260731y (Gustavo full-head from raw portrait).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607329) return;
    window.__ohBootGuard = 202607329;
    ...
    [
      ...
      "6a6cafcb09affef998e6d9b1_dealality-old-home-testimonials.v20260731y.js",
