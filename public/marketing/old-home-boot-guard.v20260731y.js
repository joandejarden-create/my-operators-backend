/**
 * Old Home Boot Guard (v20260731y)
 * Path-gated to /old-home. Same as 31x + testimonials v20260731ad (Justin Lead Asset Manager title).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607333) return;
    window.__ohBootGuard = 202607333;
