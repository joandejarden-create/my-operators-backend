/**
 * Old Home Boot Guard (v20260730b)
 * Path-gated to /old-home. Restores full critical CSS/JS list from w19 SoT +
 * freeform-head w22, platform-features 30b, globe 307, video 29i, testimonials 30a.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607302) return;
    window.__ohBootGuard = 202607302;
