/**
 * Old Home — Benefits outcomes copy (v20260730i)
 ...
 * v20260730i: shorten Outcomes bodies that wrapped past 3 lines.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohModulesCopy >= 202607309) return;
    window.__ohModulesCopy = 202607309;

    var STYLE_ID = "oh-modules-copy-30i";
    ...
    var COPY = {
      "mod-1-p":
        "Keep the asset story, owner goals, documents, questions, and responses connected in one confidential process.",
      "mod-2-p":
      ...
      "mod-4-p":
        "Coordinate outreach, responses, follow-ups, and next actions without scattered emails and separate trackers.",
      "mod-5-p":
