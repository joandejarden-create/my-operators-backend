/**
 * Old Home — How We Do It compact one-screen process (v20260802b)
 ...
 *
 * v20260802b: /es translates step labels (Tracked Outcome → Resultado registrado).
...
(function () {
  try {
    ...
    if (isEs) {
      var TITLE_ES = {
        "Define the Opportunity": "Define la oportunidad",
        "Explore Credible Paths": "Explora caminos creíbles",
        "Prepare & Engage": "Prepara e involucra",
        "Meet & Align": "Reúnete y alinea",
        "Compare What Matters": "Compara lo que importa",
        "Collaborate & Review": "Colabora y revisa",
        "Pursue the Selected Direction": "Avanza la dirección seleccionada",
        "Align & Hand Off": "Alinea y traspasa"
      };
      var LABEL_ES = {
        "Asset Context": "Contexto del activo",
        "Owner Objectives": "Objetivos del propietario",
        "Commercial Priorities": "Prioridades comerciales",
        "Control Preferences": "Preferencias de control",
        Timing: "Timing",
        "Decision Criteria": "Criterios de decisión",
        "Brand Paths": "Caminos de marca",
        "Operator Paths": "Caminos de operador",
        Conversion: "Conversión",
        "Operating Models": "Modelos operativos",
        Capital: "Capital",
        Alternatives: "Alternativas",
        "Opportunity Brief": "Brief de la oportunidad",
        ...
        "Desired outcomes": "Resultados deseados",
        Fees: "Fees",
        "Owner Control": "Control del propietario",
        "Capital Support": "Soporte de capital",
