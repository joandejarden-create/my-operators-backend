 ...
 * v20260729b: pin herofit to live SoT v20260729d (was stale v20260729c).
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohFoucGate && window.__ohFoucGate >= 202607292) return;
    window.__ohFoucGate = 202607292;
    ...
    var critical = [
      ...
      // hero-fit — live SoT v20260729d (laptop-tight + wide/tall breathing room)
      ["herofit", b + "6a6a68e1fedb6e8369ce6830_dealality-old-home-hero-fit.v20260729d.css"],
    ];
