/**
 * Old Home — unify Explore / Opportunity Review CTAs (v20260801c)
...
(function () {
  try {
    ...
    if (window.__ohExploreCta >= 202608013) return;
    window.__ohExploreCta = 202608013;

    var STYLE_ID = "oh-explore-cta-01c";
