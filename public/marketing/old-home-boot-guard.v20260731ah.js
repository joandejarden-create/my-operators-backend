/**
 * Old Home Boot Guard (v20260731ah)
 * Path-gated to /old-home.
 * Same as 31af + section-type d (unified eyebrow/H2/lead spacing) + FAQs e.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase();
    if (path !== "/old-home") return;
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607342) return;
    window.__ohBootGuard = 202607342;
