/**
 * Old Home — How We Do It compact one-screen process (v20260730s)
 ...
 * Fill shots on steps 02 (Brand Explorer), 03 (Outreach), 05 (Deal Room).
...
(function () {
  try {
    ...
    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b5ff53d2074737f78bb00_dealality-old-home-how-we-do-it.v20260730s.css";
    if (window.__ohHowWeDoIt >= 202607321) return;
    window.__ohHowWeDoIt = 202607321;
    var IMG_BRAND =
    ...
    var IMG_OUTREACH =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a679519982910d5c314bf02_matched-brands.png";
    var IMG_PURSUE =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a67951939a6297b82de0b4e_deal-room.png";
    ...
    var STEPS = [
      ...
      },
      {
        ...
        visual: "engage",
        img: IMG_OUTREACH,
        alt: "Outreach workspace showing matched brands and engagement status",
      },
      {
        n: "04",
      ...
      },
      {
        ...
        visual: "pursue",
        img: IMG_PURSUE,
        alt: "Deal room workspace for pursuing the selected direction",
      },
    ];
    ...
    function ensureCss(onReady) {
      ...
      if (existing) {
        var same = (existing.getAttribute("href") || "").indexOf("v20260730s.css") !== -1;
        existing.setAttribute("href", CSS_HREF);
        existing.setAttribute("data-oh-how", "30s");
        if (same) ready();
        else {
      ...
      if (document.querySelector('link[data-oh-how="30s"]')) {
        ready();
        return;
      }
      ...
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "30s");
    ...
    function visualHtml(step) {
      ...
      if (step.visual === "paths") {
        return (
          ...
          '<div class="dealality-process_shot is-fill-shot is-paths-shot">' +
          (step.img
            ? '<img src="' +
              esc(step.img) +
              '" alt="' +
              esc(step.alt) +
              '" loading="eager" width="960" height="220">'
            : "") +
          "</div>" +
          '<div class="dealality-process_panel">' +
          '<div class="dealality-process_panel-head">' +
      ...
      if (step.visual === "engage") {
        return (
          ...
          '<div class="dealality-process_shot is-fill-shot is-outreach-shot">' +
          (step.img
            ? '<img src="' +
              esc(step.img) +
              '" alt="' +
      ...
      return (
        ...
        '<div class="dealality-process_shot is-fill-shot is-pursue-shot">' +
        (step.img
          ? '<img src="' +
            esc(step.img) +
            '" alt="' +
    ...
    function mount() {
      ...
      if (existing && existing.getAttribute("data-oh-how") === "30s") return true;
