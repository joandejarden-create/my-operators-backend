/**
 * Old Home — How We Do It compact one-screen process (v20260730n)
...
(function () {
  try {
    ...
    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b58881423364ef1410a2e_dealality-old-home-how-we-do-it.v20260730n.css";
    if (window.__ohHowWeDoIt >= 202607317) return;
    window.__ohHowWeDoIt = 202607317;
    var IMG_BRAND =
    ...
    function ensureCss() {
      ...
      if (existing) {
        ...
        existing.setAttribute("data-oh-how", "30n");
        return;
      }
      if (document.querySelector('link[data-oh-how="30n"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-how", "30n");
    ...
    function bind(section) {
      ...
      function lockEqualHeight() {
        if (!content || !steps.length) return;
        var prevActive = active;
        var prevMin = content.style.minHeight;
        var prevHeight = content.style.height;
        ...
        for (var i = 0; i < steps.length; i++) {
          ...
          // Force layout, ignore animation transform for measure
          var h = content.scrollHeight;
          if (h > max) max = h;
        }
        // Restore active step without analytics
        steps.forEach(function (el, j) {
          var on = j === prevActive;
          el.classList.toggle("is-active", on);
          if (on) el.removeAttribute("hidden");
        ...
        if (max > 0) {
          ...
          content.style.minHeight = prevMin;
