#!/usr/bin/env node
/**
 * Build Costa Rica countrywide demand anchor candidate fixtures.
 */
...
import {
  getCostaRicaCandidates,
  COSTA_RICA_SUBMARKETS,
} from "../lib/radar-buildout/costa-rica-demand-anchors-candidates.js";
import { applyCostaRicaPlaceReviewCorrections } from "../lib/radar-buildout/costa-rica-google-place-review-corrections.js";

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = join(__dirname, "..");
const MARKET = "Costa Rica Countrywide";
const config = getCountryConfig("Costa Rica");

const points = applyCostaRicaPlaceReviewCorrections(getCostaRicaCandidates());
const bySubmarket = {};
const byPointType = {};
const byCity = {};
...
const fixture = {
  ...
  submarkets: COSTA_RICA_SUBMARKETS,
...
const paths = [
  ...
  "public/fixtures/demand-anchors-costa-rica-countrywide-candidates.json",
];
...
console.log("Costa Rica countrywide candidates written:", points.length);
