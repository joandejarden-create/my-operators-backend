...
const filePath = path.join(
  root,
  "public/marketing/old-home-section-order.v20260730h.js"
);
const metaPath = path.join(__dirname, "tmp-wf-upload-section-order30h.json");
...
form.append(
  "file",
  new Blob([bytes], { type: u.contentType }),
  "old-home-section-order.v20260730h.js"
);
