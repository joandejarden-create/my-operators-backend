...
import {
  getCubaCandidates,
  CUBA_SUBMARKETS,
} from "../lib/radar-buildout/cuba-demand-anchors-candidates.js";
import { applyCubaPlaceReviewCorrections } from "../lib/radar-buildout/cuba-google-place-review-corrections.js";

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = join(__dirname, "..");
const MARKET = "Cuba Countrywide";
const config = getCountryConfig("Cuba");

const points = applyCubaPlaceReviewCorrections(getCubaCandidates());
const bySubmarket = {};
const byPointType = {};
const byCity = {};
...
for (const rel of [
  "fixtures/demand-anchors-cuba-candidates.json",
  "public/fixtures/demand-anchors-cuba-candidates.json",
]) {
  writeFileSync(join(root, rel), JSON.stringify(fixture, null, 2) + "\n");
}

console.log("Cuba Countrywide candidates written:", points.length);
