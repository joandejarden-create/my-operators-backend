#!/usr/bin/env node
/**
 * Build Panama countrywide demand anchor candidate fixtures.
 */
...
import {
  getPanamaCandidates,
  PANAMA_SUBMARKETS,
} from "../lib/radar-buildout/panama-demand-anchors-candidates.js";
import { applyPanamaPlaceReviewCorrections } from "../lib/radar-buildout/panama-google-place-review-corrections.js";

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = join(__dirname, "..");
const MARKET = "Panama Countrywide";
const config = getCountryConfig("Panama");

const points = applyPanamaPlaceReviewCorrections(getPanamaCandidates());
const bySubmarket = {};
const byPointType = {};
const byCity = {};
...
const paths = [
  ...
  "public/fixtures/demand-anchors-panama-countrywide-candidates.json",
];
...
console.log("Panama countrywide candidates written:", points.length);
