...
import {
  getUsVirginIslandsCandidates,
  US_VIRGIN_ISLANDS_SUBMARKETS,
} from "../lib/radar-buildout/us-virgin-islands-demand-anchors-candidates.js";
import { applyUsVirginIslandsPlaceReviewCorrections } from "../lib/radar-buildout/us-virgin-islands-google-place-review-corrections.js";

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = join(__dirname, "..");
const MARKET = "U.S. Virgin Islands Countrywide";
const config = getCountryConfig("U.S. Virgin Islands");

const points = applyUsVirginIslandsPlaceReviewCorrections(getUsVirginIslandsCandidates());
const bySubmarket = {};
const byPointType = {};
const byCity = {};
...
const fixture = {
  ...
  submarkets: US_VIRGIN_ISLANDS_SUBMARKETS,
...
for (const rel of [
  "fixtures/demand-anchors-us-virgin-islands-candidates.json",
  "public/fixtures/demand-anchors-us-virgin-islands-candidates.json",
]) {
  writeFileSync(join(root, rel), JSON.stringify(fixture, null, 2) + "\n");
}

console.log("U.S. Virgin Islands Countrywide candidates written:", points.length);
