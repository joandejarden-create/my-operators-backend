...
const details = JSON.parse(
  process.env.WF_UPLOAD_DETAILS ||
    fs.readFileSync(process.env.WF_UPLOAD_DETAILS_FILE || "tmp-upload-details.json", "utf8")
);
const fileName = process.env.WF_FILE_NAME || "dealality-old-home-dark.v20260728.css";
const filePath = process.env.WF_FILE_PATH || "tmp-old-home-dark.css";
