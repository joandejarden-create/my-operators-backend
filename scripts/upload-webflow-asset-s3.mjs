...
const filePath = 'public/marketing/dealality-old-home-owner-boot.bundle.js';
const file = fs.readFileSync(filePath);
console.log('md5', crypto.createHash('md5').update(file).digest('hex'), 'bytes', file.length);
...
parts.push(
  Buffer.from(
    `--${boundary}\r\nContent-Disposition: form-data; name="file"; filename="dealality-old-home-owner-boot.bundle.js"\r\nContent-Type: application/javascript\r\n\r\n`
  )
);
parts.push(file);
