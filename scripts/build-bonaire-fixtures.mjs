...
import {
  getBonaireCandidates,
  BONAIRE_SUBMARKETS,
} from "../lib/radar-buildout/bonaire-demand-anchors-candidates.js";
import { applyBonairePlaceReviewCorrections } from "../lib/radar-buildout/bonaire-google-place-review-corrections.js";

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = join(__dirname, "..");
const MARKET = "Bonaire Countrywide";
const config = getCountryConfig("Bonaire");

const points = applyBonairePlaceReviewCorrections(getBonaireCandidates());
const bySubmarket = {};
const byPointType = {};
const byCity = {};
...
for (const rel of [
  "fixtures/demand-anchors-bonaire-candidates.json",
  "public/fixtures/demand-anchors-bonaire-candidates.json",
]) {
  writeFileSync(join(root, rel), JSON.stringify(fixture, null, 2) + "\n");
}

console.log("Bonaire Countrywide candidates written:", points.length);
