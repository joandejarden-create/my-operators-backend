/**
 * Old Home — Features image-overlay tiles (v20260730s)
 * Path-gated to /old-home.
 * Image tiles: full-bleed screenshot; blue caption with title + body always visible.
 * No hover hide/show text and no image zoom on hover.
 * Opportunity Review, Smart Matching, Brand Explorer, Operator Explorer,
 * Owner-Controlled Process, Structured Deal Responses, and Deal Readiness (snapshot score/stage) use cropped app screenshots.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohPlatformFeaturesTiles >= 202607318) return;
    window.__ohPlatformFeaturesTiles = 202607318;

    var CSS_HREF =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b72d7bf02381b3d0e61e1_dealality-old-home-platform-features.v20260730r.css";
    ...
    var IMG_OWNER =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b6b40cea96a6610beeef9_dealality-old-home-feature-owner-controlled.v20260730n.png";
    var IMG_READINESS =
      "https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6b764c565610c7c74042bf_dealality-old-home-feature-deal-readiness.v20260730s.png";
    ...
    var TILES = [
      ...
      },
      {
        ...
        image: IMG_READINESS,
        imageAlt:
          "Deal Readiness Snapshot with final readiness score 92 of 100 and Ready for External Review stage",
      },
      {
        id: 3,
        icon: "SM",
      ...
      },
      {
        ...
        image: IMG_OWNER,
        imageAlt:
          "Outreach Setup controls for confidentiality, identity disclosure, and who outreach comes from",
      },
      {
        id: 8,
        icon: "SR",
    ...
    function ensureCss() {
      ...
      for (i = 0; i < links.length; i++) {
        ...
        links[i].setAttribute("data-oh-pf", "30o");
      }
      if (document.querySelector('link[data-oh-pf="30s"]')) return;
      var link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = CSS_HREF;
      link.setAttribute("data-oh-pf", "30o");
    ...
    function apply() {
      ...
      if (!grid) return;
      if (grid.getAttribute("data-oh-pf-tiles") === "30s") return;
      grid.innerHTML = TILES.map(cardHtml).join("");
      grid.setAttribute("data-oh-pf-tiles", "30s");
    }
