...
const code =
  ...
  '<link rel="stylesheet" href="https://cdn.prod.website-files.com/68108c29063eeb5d1bd7ae4a/6a6d2395e8d817b263df5cd0_old-home-manual-process.v20260731l.css" />' +
...
fs.writeFileSync(
  "tmp/wf-set-dmp-embed-circular.json",
  JSON.stringify({
    siteId: "68108c29063eeb5d1bd7ae4a",
    pageId: "68108c2a063eeb5d1bd7ae90",
    context:
      "Point Manual Process embed at circular-spread CSS l and boot k.",
    actions: [
      {
        label: "set_embed",
        set_settings: {
