...
- **Active brands searched:** 9
- **Parent companies searched:** Accor
...
- **Discovered properties:** 77
- **Existing Hotel Property Census matches:** 0
- **New property candidates:** 77
- **Duplicate risks:** 0
- **Steward review cases:** 0
- **Source families used:** Accor, VIC_evidence
...
- **Estimated insert count if applied:** 77
...
ALLOW_CENSUS_AUTOPILOT_APPLY=1 \
  ...
  --approval-bundle reports/research-engine-v2/autopilot/2026-08-06T11-31-00_CALA-source-discovery/approval-bundle.json \
