...
5. **Total processed:** 177
6. **Total updated:** 177
7. **Total skipped:** 0
8. **Total blocked:** 0
9. **Fields populated:** City, State / Region
10. **Confidence High/Medium/Low/Hold:** 177 / 0 / 0 / 0
11. **Runtime:** 116 ms
...
```bash
npm run census:autopilot -- --region CALA --scope active-brand-setup --mode apply --strategy fastest-safe --run-until-complete --batch-size 250 --approval-bundle reports/research-engine-v2/autopilot/2026-08-06_13-43-43-CALA-active-brands/approval-bundle.json --confirm-approval-bundle-bound --enable-production-writes (+ all confirm flags)
```
