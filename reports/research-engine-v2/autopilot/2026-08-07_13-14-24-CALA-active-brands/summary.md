...
3. **Mode:** controlled
4. **Total records in scope:** 590
5. **Total processed:** 590
6. **Total updated:** 590
7. **Total skipped:** 0
8. **Total blocked:** 0
9. **Fields populated:** Brand Family, Data Confidence Tier, Enrichment Status, Enrichment Priority, Last Reviewed Date
10. **Confidence High/Medium/Low/Hold:** 590 / 0 / 0 / 0
11. **Runtime:** 117 ms
...
```bash
npm run census:autopilot -- --region CALA --scope active-brand-setup --mode apply --strategy fastest-safe --run-until-complete --batch-size 250 --approval-bundle reports/research-engine-v2/autopilot/2026-08-07_13-14-24-CALA-active-brands/approval-bundle.json --confirm-approval-bundle-bound --enable-production-writes (+ all confirm flags)
```
