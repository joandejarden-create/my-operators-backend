...
- **Why:** Targeted queue run (--queue parent_company_normalization); fastest-safe order overridden.
...
15. **A0parent. Brand Family / Parent Company normalization** (`parent_company_normalization`) — score 0.0892
16. **A0e. Canonical Property Name completion** (`canonical_property_name_completion`) — score 0.0892
17. **C2. Coordinate resolution (legacy soft-defer)** (`coordinate_resolution`) — score 0.0595
18. **A0c. Core identity source lookup** (`core_identity_source_lookup`) — score 0.0547
19. **A0d. Clean Core classification** (`clean_core_classification`) — score 0.0541
20. **A. Source discovery / record matching** (`source_discovery`) — score 0.0476
21. **I. Steward / Webhound hard cases** (`steward_webhound_hard_cases`) — score 0.0014
