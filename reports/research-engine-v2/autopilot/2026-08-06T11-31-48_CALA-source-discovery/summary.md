...
- **Active brands searched:** 4
- **Parent companies searched:** Wyndham
...
- **Discovered properties:** 80
- **Existing Hotel Property Census matches:** 0
- **New property candidates:** 80
- **Duplicate risks:** 0
- **Steward review cases:** 0
- **Source families used:** Wyndham, VIC_evidence
...
- **Estimated insert count if applied:** 80
...
ALLOW_CENSUS_AUTOPILOT_APPLY=1 \
  ...
  --approval-bundle reports/research-engine-v2/autopilot/2026-08-06T11-31-48_CALA-source-discovery/approval-bundle.json \
