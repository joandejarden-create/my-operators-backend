...
- **Active brands searched:** 12
- **Parent companies searched:** Hilton
...
- **Discovered properties:** 158
- **Existing Hotel Property Census matches:** 102
- **New property candidates:** 56
- **Duplicate risks:** 0
- **Steward review cases:** 0
- **Source families used:** Hilton, VIC_evidence
...
- **Estimated insert count if applied:** 56
...
ALLOW_CENSUS_AUTOPILOT_APPLY=1 \
  ...
  --approval-bundle reports/research-engine-v2/autopilot/2026-08-05T23-52-06_CALA-source-discovery/approval-bundle.json \
