...
3. **Mode:** controlled
4. **Total records in scope:** 5
5. **Total processed:** 5
6. **Total updated:** 5
7. **Total skipped:** 0
8. **Total blocked:** 0
9. **Fields populated:** Property Name, Last Reviewed Date, Enrichment Status, Enrichment Priority
10. **Confidence High/Medium/Low/Hold:** 5 / 0 / 0 / 0
11. **Runtime:** 48 ms
