...
- **Active brands searched:** 0
- **Parent companies searched:** (n/a)
...
- **Discovered properties:** 231
- **Existing Hotel Property Census matches:** 194
- **New property candidates:** 37
- **Duplicate risks:** 0
- **Steward review cases:** 0
- **Source families used:** IHG, VIC_evidence
...
- **Estimated insert count if applied:** 37
...
ALLOW_CENSUS_AUTOPILOT_APPLY=1 \
  ...
  --approval-bundle reports/research-engine-v2/autopilot/2026-08-05T23-51-50_CALA-source-discovery/approval-bundle.json \
