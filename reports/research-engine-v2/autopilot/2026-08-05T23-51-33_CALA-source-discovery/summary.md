...
- **Estimated insert count if applied:** 93
...
ALLOW_CENSUS_AUTOPILOT_APPLY=1 \
  ...
  --approval-bundle reports/research-engine-v2/autopilot/2026-08-05T23-51-33_CALA-source-discovery/approval-bundle.json \
