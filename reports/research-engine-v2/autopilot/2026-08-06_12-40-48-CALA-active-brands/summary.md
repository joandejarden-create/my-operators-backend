...
3. **Mode:** controlled
4. **Total records in scope:** 127
5. **Total processed:** 127
6. **Total updated:** 127
7. **Total skipped:** 0
8. **Total blocked:** 0
9. **Fields populated:** Geocode Provider, Geocode Method, Geocode Reviewed Date, Address Confidence, Address Source URL, Canonical Property Name
10. **Confidence High/Medium/Low/Hold:** 127 / 0 / 0 / 0
11. **Runtime:** 103 ms
...
```bash
npm run census:autopilot -- --region CALA --scope active-brand-setup --mode apply --strategy fastest-safe --run-until-complete --batch-size 250 --approval-bundle reports/research-engine-v2/autopilot/2026-08-06_12-40-48-CALA-active-brands/approval-bundle.json --confirm-approval-bundle-bound --enable-production-writes (+ all confirm flags)
```
