...
- **Discovered properties:** 398
- **Existing Hotel Property Census matches:** 301
- **New property candidates:** 93
- **Duplicate risks:** 0
- **Steward review cases:** 4
...
- **Marriott MARSHA coverage:** 398/398
- **Estimated insert count if applied:** 65
...
ALLOW_CENSUS_AUTOPILOT_APPLY=1 \
  ...
  --approval-bundle reports/research-engine-v2/autopilot/2026-08-05T23-45-32_CALA-source-discovery/approval-bundle.json \
