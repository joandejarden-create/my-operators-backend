...
- **Sheraton Santo Domingo Hotel** (Sheraton, Santo Domingo, Dominican Republic) — `missing_high_confidence` — https://www.marriott.com/en-us/hotels/sdqds-sheraton-santo-domingo-hotel/overview — MARSHA/code: SDQDS
- **Sheraton Bogota Hotel** (Sheraton, Bogotá, Colombia) — `missing_high_confidence` — https://www.marriott.com/en-us/hotels/bogsi-sheraton-bogota-hotel/overview — MARSHA/code: BOGSI
- **Sheraton Grand Panama** (Sheraton, Panama City, Panama) — `missing_high_confidence` — https://www.marriott.com/en-us/hotels/ptysi-sheraton-grand-panama/overview — MARSHA/code: PTYSI
