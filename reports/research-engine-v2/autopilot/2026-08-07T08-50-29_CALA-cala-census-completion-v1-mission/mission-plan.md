...
1. **Reconfirm Brand / Core Identity** (`phase_2_reconfirm_brand_core`) — queues: brand_normalization, core_identity_quality, core_identity_source_lookup, canonical_property_name_completion, city_state_normalization
