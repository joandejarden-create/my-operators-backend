...
- **Parent companies searched:** Accor, BWH Hotels, Bunkhouse, Choice, Hilton, IHG, Marriott, Preferred Hotels & Resorts, SLH, Wyndham
...
- **Discovered properties:** 561
- **Existing Hotel Property Census matches:** 397
- **New property candidates:** 164
- **Duplicate risks:** 0
- **Steward review cases:** 0
- **Source families used:** Hilton, Choice, Marriott, IHG, Accor, Wyndham, Preferred, VIC_evidence
...
- **Marriott MARSHA coverage:** 226/226
- **Estimated insert count if applied:** 164
...
ALLOW_CENSUS_AUTOPILOT_APPLY=1 \
  ...
  --approval-bundle reports/research-engine-v2/autopilot/2026-08-06T11-33-18_CALA-source-discovery/approval-bundle.json \
