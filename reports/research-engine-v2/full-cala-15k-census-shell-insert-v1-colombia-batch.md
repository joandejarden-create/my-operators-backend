...
**Generated:** 2026-08-09T17:17:20.651Z  
**Dry run:** false  
**Airtable inserts:** **500**

## Universe
- Existing Census before: **3757**
- Total staging candidates: **16364**
- Eligible shell inserts: **12480**
- Expected Census after full insert (approx): **16237**

## Classification
- `existing_match_high`: **3047**
- `probable_duplicate_hold`: **740**
- `existing_match_medium`: **90**
- `new_candidate_medium`: **10809**
- `possible_duplicate_review`: **6**
- `new_candidate_high`: **1671**
- `reject_non_hotel`: **1**
...
- Planned inserts: **500**
- Applied: **500**
- Country eligible (pre-cap): **1149**
- Country remaining eligible: **649**
- Source mix (batch): {"cvent_candidate":117,"hbx_content_api":383}
- HBX codes in batch: **500**
- Census after (estimate): **4257**
- HBX field index hits: **1408**
- Plan skipped (HBX in-batch dedupe): **0**
- Plan skipped (name+country in-batch): **283**
