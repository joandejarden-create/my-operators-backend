# Brand Explorer — Protected 54 Active/Live Public-Full Baseline

Version: `54-active-public-full-baseline-v1` · Generated: 2026-08-03T20:15:48.443Z
Baseline type: **active_live_public_full**
Freeze decision: **`frozen_54_active_public_full_baseline_semantic_clean_flex_held`** · frozen=true
Writes: Airtable=false · Presentation=false · Image=false · CV=false · Source=false · Registry=false · Brand Status=false

## 1. Executive summary

This freeze locks the **54** Brand Basics Active/Live Brand Explorer profiles that are public-full, PVQL-clean, quality `approve_for_baseline_freeze`, and AI-Assisted footnote-complete after Wave 14 Marriott International partial promotion (8 of 9 brands) + public release + semantic cleanup. Four Points Flex by Sheraton is **held** (Under Review). Predecessor: protected **46**.

| Metric | Value |
|--------|-------|
| Active/Live count | 54 |
| Public-full | 54 |
| shouldRenderFullProfile | 54 |
| PVQL pass | 54 |
| approve_for_baseline_freeze | 53 |
| remediation_required | 0 |
| AI-Assisted footnote visible | 54 |
| Footnote complete (LR+SB+Region) | 54 |
| Evidence quality (mandatory wave) | true |
| Image uniqueness pass | 54 |
| Image role-match pass | 54 |
...
| Aloft Hotels | `aloft-hotels` | `recJ1GZQpttX7qHgw` | Active | true | active_profile_ready | pass | approve_for_baseline_freeze | true | Jul 28, 2026 | Company Materials + Public Sources | CALA-informed | pass | pass | pass | 6 | 3 | 3 | 102 | false |
...
| Marriott | `marriott-hotels` | `recn59UtkyyoYwzSz` | Active | true | active_profile_ready | pass | approve_for_baseline_freeze | true | Jul 28, 2026 | Company Materials + Public Sources | CALA-informed | pass | pass | pass | 6 | 3 | 3 | 102 | false |
...
| MGallery Collection | `mgallery-collection` | `recrWCD1LMqu864oU` | Active | true | active_profile_ready | pass | approve_after_minor_cleanup | true | Jul 23, 2026 | Company Materials | International Reference | pass | pass | n_a_protected_prior | 6 | 3 | 3 | 94 | false |
...
| Residence Inn by Marriott | `residence-inn-by-marriott` | `rec9Ufbpa0GxJGzt8` | Active | true | active_profile_ready | pass | approve_for_baseline_freeze | true | Jul 28, 2026 | Company Materials + Public Sources | CALA-informed | pass | pass | pass | 6 | 3 | 3 | 102 | false |
| Sheraton | `sheraton` | `recg8HjT5Bky7NXeV` | Active | true | active_profile_ready | pass | approve_for_baseline_freeze | true | Jul 28, 2026 | Company Materials + Public Sources | CALA-informed | pass | pass | pass | 6 | 3 | 3 | 102 | false |
...
| SpringHill Suites by Marriott | `springhill-suites-by-marriott` | `recBzdGfkMUN9fYsv` | Active | true | active_profile_ready | pass | approve_for_baseline_freeze | true | Jul 28, 2026 | Company Materials + Public Sources | CALA-informed | pass | pass | pass | 6 | 3 | 3 | 101 | false |
| StudioRes | `studiores` | `recDM0LAD8jVRA2x3` | Active | true | active_profile_ready | pass | approve_for_baseline_freeze | true | Jul 28, 2026 | Company Materials + Public Sources | International Reference | pass | pass | pass | 6 | 3 | 3 | 101 | false |
...
| TownePlace Suites by Marriott | `towneplace-suites-by-marriott` | `recUPiPDivkhNUogr` | Active | true | active_profile_ready | pass | approve_for_baseline_freeze | true | Jul 28, 2026 | Company Materials + Public Sources | CALA-informed | pass | pass | pass | 6 | 3 | 3 | 101 | false |
...
| Westin | `westin` | `recIPuBC50fv13zRR` | Active | true | active_profile_ready | pass | approve_for_baseline_freeze | true | Jul 28, 2026 | Company Materials + Public Sources | CALA-informed | pass | pass | pass | 6 | 3 | 3 | 102 | false |
...
- Public eight slugs: `marriott-hotels`, `sheraton`, `westin`, `residence-inn-by-marriott`, `springhill-suites-by-marriott`, `towneplace-suites-by-marriott`, `aloft-hotels`, `studiores`
- Held slug: `four-points-flex-by-sheraton` (excluded=true)
- Expected partial active count: 54
- Value scenario visual remediation: `brand-explorer-wave14-value-scenario-visual-remediation.json`
- Dated momentum cleanup: `brand-explorer-wave14-dated-momentum-cleanup.json`
- Founder visual/semantic remediation: `brand-explorer-wave14-founder-visual-semantic-remediation.json`
- Public/Active semantic blocker cleanup: `brand-explorer-wave14-public-active-semantic-blocker-cleanup.json`
...
- Footnote visible count: **54** / complete: **54**

## 6. Validation results

- Quality audit: brand-explorer-24-tab-section-quality-audit.json (freeze_after_minor_cleanup_pass)
- PVQL: brand-explorer-public-visibility-quality-lock.json (publicFull=54; overallPass=true)
...
Public-full PVQL must be **54/54** lockPass, including `ai_assisted_profile_footnote_visible`.
Snapshot: publicFull=54 · overallPass=true

## 8. 24-tab quality result

All Active/Live brands must be `approve_for_baseline_freeze` with blockerCount=0 (accepted minor: `mgallery-collection`).
Freeze recommendation count: **53** · remediation: **0**
...
- Value scenario visual remediation: `brand-explorer-wave14-value-scenario-visual-remediation.json` · ready: **wave14_value_scenario_visual_quality_clean_ready_for_54_freeze**
- Founder visual/semantic remediation: `brand-explorer-wave14-founder-visual-semantic-remediation.json` · ready: **wave14_founder_visual_semantics_clean_ready_for_value_scenario_recheck_and_54_freeze**
- Public/Active semantic blocker cleanup: `brand-explorer-wave14-public-active-semantic-blocker-cleanup.json` · ready: **wave14_public_active_semantic_blockers_clean**
...
- Dated momentum cleanup: `brand-explorer-wave14-dated-momentum-cleanup.json` · ready: **wave14_dated_momentum_cleanup_applied_ready_for_pvql_recheck**
...
These brands are **explicitly excluded** from the 54 Active/Live public-full freeze:
...
Test: `npm run test:brand-explorer-54-active-public-full-baseline`
...
```bash
npm run brand-explorer-54-active-public-full-baseline -- --dry-run
npm run test:brand-explorer-54-active-public-full-baseline
