...
**Generated:** 2026-08-07T08:52:24.201Z
...
| Decision | Count |
| --- | ---: |
| auto_insert (total) | 62 |
| — no Human Review | 19 |
| — with Human Review | 43 |
| production_writable_insert | 62 |
...
| Reason | Count |
| --- | ---: |
| `missing_official_property_url` | 80 |
| `known_chain_backlog_gates_passed_hr` | 29 |
| `steward_unresolved_osm_brand_tag` | 23 |
| `independent_gates_passed` | 16 |
| `known_chain_backlog_insert_city_unknown_hr` | 14 |
| `official_url_denylisted_ota_or_social` | 7 |
| `active_or_soft_brand_gates_passed` | 3 |
| `known_brand_missing_city` | 1 |
...
| Radisson Blu Resort & Residence, Punta Cana | Radisson Blu by Choice | Punta Cana | false | active_or_soft_brand_census_plus_autopilot |
| Viva Dominicus Beach by Wyndham | Wyndham | Unknown | true | known_chain_census_backlog_not_active_setup |
| Iberostar Waves Punta Cana | Iberostar | Punta Cana | true | known_chain_census_backlog_not_active_setup |
| Iberostar Waves Dominicana | Iberostar | Punta Cana | true | known_chain_census_backlog_not_active_setup |
| Hotel Riu Palace Macao | RIU | Punta Cana | true | known_chain_census_backlog_not_active_setup |
| Hotel Riu Bambu | RIU | Punta Cana | true | known_chain_census_backlog_not_active_setup |
| Barceló Bávaro Beach – Adults only | Barceló | Unknown | true | known_chain_census_backlog_not_active_setup |
| Iberostar Selection Bavaro Suites | Iberostar | Punta Cana | true | known_chain_census_backlog_not_active_setup |
...
| Catalonia Punta Cana | missing_official_property_url |
...
| Hodelpa Novus Plaza | missing_official_property_url |
...
| Four Points by Sheraton | missing_official_property_url |
...
| Occidental Caribe (former Barcelo Punta Cana) | missing_official_property_url |
| Occidental Caribe (former Barcelo Punta Cana) | missing_official_property_url |
| Grand Bahia Principe Punta Cana | missing_official_property_url |
| Riu Palace Punta Cana | missing_official_property_url |
| Real Intercontinental | missing_official_property_url |
| Breathless Resort | missing_official_property_url |
| Embassy Suites by Hilton | missing_official_property_url |
