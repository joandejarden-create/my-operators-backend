...
const QUESTION_TEMPLATE_RULES = [
  ...
  },
  {
    ...
    match: [
      /proposed\s*hotel/i,
      /suspected\s*(hotel\s*)?development/i,
      /under[\s-]?construction/i,
      /stalled\s*project/i,
      /hotel\s*\+?\s*residences/i,
      /branded\s*residences/i,
      /mixed[\s-]?use/i,
      /development\s*site/i,
      /entitlement/i,
      /pre[\s-]?development/i,
      /pipeline\s*project/i,
    ],
    reason_fallback:
      "A proposed, suspected, or in-progress hotel development at the site remains unresolved.",
  },
  {
