...
export const RESEARCH_TEMPLATES = Object.freeze({
  ...
  OWNER_PORTFOLIO: baseTemplate({
    ...
    research_questions: [
      "What hotels does this organization currently own?",
      "What hotels does it control through subsidiaries / PropCos?",
      "What hotels does it hold through JVs?",
      "What hotels does it sponsor economically?",
      "What hotels does it operate/manage but NOT own?",
      "What hotels did it historically own?",
      "What hotels are in pipeline/development?",
      "What related owner entities exist?",
      "What parent / subsidiary / JV structures connect them?",
    ...
    negative_screens: [
      "operator_not_owner",
      "managed_not_owned",
      "jv_partner_portfolio_not_imported",
      "affiliate_not_controlled",
      "historical_not_current",
      "announced_not_current",
    ],
  }),

  DEVELOPMENT_PROJECT_INTELLIGENCE: baseTemplate({
    template_id: "DEVELOPMENT_PROJECT_INTELLIGENCE",
    version: "1.0.0",
    display_name: "Development & Project Intelligence Investigation",
    customer_question: "Investigate a proposed or suspected hotel development.",
    short_question: "What appears to be happening at this development site?",
    description:
      "Investigate suspected, proposed, planned, stalled, under-development, or under-construction hotel and hotel+residences projects at the site level — including ownership/control, developer, brand/operator status, program, entitlements, capital, timeline, market context, commercial opportunity signals, and open questions. Works without an operating-hotel Census record.",
    research_objective:
      "Determine what can be evidenced about a proposed or suspected hotel development at a specific site: identity, control structure, developer, brand/operator status, program, stage, timeline, capital, team, market context, risks, and commercial opportunity signals — with explicit uncertainty states.",
    required_inputs: ["hotel_id", "hotel_name"],
    optional_inputs: [
      "known_facts",
      "known_gaps",
    ...
    research_lanes: [
      ...
      "development_stage",
      "timeline",
      "permits_entitlements",
      "capital_financing",
      "transactions",
      "development_team",
      "people_decision_authority",
      "current_activity_signals",
      "physical_site_signals",
      "market_pipeline_context",
      "brand_development_lens",
      "operator_development_lens",
      "investor_lender_lens",
    ...
    preferred_source_classes: [
      "government_legal_registry",
      "securities_filings",
      "land_planning_permit",
      "owner_developer_first_party",
      "brand_operator_first_party",
      "lender_capital_first_party",
      "architect_contractor_first_party",
      "credible_transaction_hotel_local_press",
      "professional_profiles",
      "secondary_discovery",
    ],
    extraction_targets: [
    ...
    validation_rules: [
      ...
      "exact_site_identity",
      "owner_developer_separation",
      "brand_status_temporal",
      "operator_status_temporal",
      "development_stage_not_inferred_from_weak_source",
      "no_title_equals_authority",
      "correct_abstention_valid",
    ],
    negative_screens: [
      "WRONG_SITE",
      "ADJACENT_PROJECT",
    ...
    stop_conditions: ["budget_exhausted", "core_lanes_complete_or_blocked", "site_identity_unresolvable"],
    escalation_conditions: [
      "native_coverage_gap",
      "hard_case_authority_gap",
      "permit_filing_not_retrievable_natively",
    ],
    default_provider_strategy: "NATIVE_THEN_ESCALATE",
    default_provider_budget_usd: 5,
    max_provider_budget_usd: 5,
    report_template: "RESEARCH_ADDENDUM",
    research_unit_estimate: 8,
    estimated_research_units: 8,
    pricing_tier_key: "development_project_intelligence_v1",
    icon: "development",
    is_baseline: false,
    allows_non_operating_hotel_subject: true,
    ...
    confirmation_eyebrow: "Deep Research",
    confirmation_title: "Start Development & Project Intelligence Investigation?",
    confirmation_summary:
      "Dealality will investigate this proposed or suspected hotel development using public evidence. Conclusions will distinguish verified facts from probable signals and unresolved questions. No operating hotel record is required.",
    confirmation_deliverables: [
      "Development & Project Intelligence Investigation",
      "Current project assessment",
      "Verified vs unverified table",
      "Ownership / developer / brand / operator status",
      "Timeline, permits, capital, and open questions",
      "Downloadable PDF",
      "Archived research history",
    ],
    scope_labels: [
