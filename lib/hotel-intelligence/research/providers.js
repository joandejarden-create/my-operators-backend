...
import {
  ...
  buildWebhoundResearchPrompt,
  buildWebhoundOutputInstructions,
} from "./hotel-seed.js";
  ...
  return {
    ...
    buildJobPayload(input = {}) {
      ...
      return {
        ...
        negative_screens: input.template?.negative_screens || [],
        prompt: buildWebhoundResearchPrompt({
          hotel_seed,
        ...
        output_instructions: buildWebhoundOutputInstructions(input.template),
      };
    },
