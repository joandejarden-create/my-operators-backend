...
export const DEVELOPMENT_PROJECT_INTELLIGENCE_REQUIRED_SECTIONS = Object.freeze([
  "executive_project_assessment",
  "what_we_think_is_happening",
  "site_project_identity",
  "ownership_land_control",
  "project_program",
  "development_status_timeline",
  "permits_entitlements_government",
  "brand_operator_intelligence",
  "capital_financing_transactions",
  "development_team",
  "people_decision_authority",
  "market_pipeline_context",
  "current_activity_signals",
  "commercial_opportunity_signals",
  "risks_what_could_derail",
...
export const REPORT_CONTRACTS = Object.freeze({
  ...
  RESEARCH_ADDENDUM: {
    ...
    templates: Object.freeze({
      ...
      DEVELOPMENT_PROJECT_INTELLIGENCE: {
        template_id: "DEVELOPMENT_PROJECT_INTELLIGENCE",
        required_sections: DEVELOPMENT_PROJECT_INTELLIGENCE_REQUIRED_SECTIONS,
        aliases: {
          executive_answer: "executive_project_assessment",
          current_project_assessment: "what_we_think_is_happening",
        },
      },
    }),
  },
