...
/** Customer-facing dossiers: identity enrich + strip Dealality infrastructure language. */
function toCustomerFacingDossier(raw) {
  if (!raw) return null;
  return enforceClientSafeCustomerSurfaces(enrichReportForPublishing(raw));
}
