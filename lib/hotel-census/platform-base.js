...
import { guardLegacyCensusBase } from "./legacy-census-write-guard.js";
...
export function getPlatformBase() {
  ...
  if (!cachedBase) {
    // P8.1: Hotel Census is READ-ONLY migration archive by default.
    cachedBase = guardLegacyCensusBase(new Airtable({ apiKey }).base(baseId));
  }
  return cachedBase;
}
