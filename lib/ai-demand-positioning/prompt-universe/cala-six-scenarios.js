...
export const CASAS_DEL_XVI_SCENARIOS = Object.freeze([
  S("prop_cdx_01", "leisure", "best_for", "Casas del XVI in Santo Domingo Colonial City for a leisure stay"),
  S("prop_cdx_02", "couples", "recommend", "Casas del XVI Vignette Collection with IHG One Rewards for a couples getaway"),
  S("prop_cdx_03", "leisure", "where_should", "Where to stay at Casas del XVI near the First Cathedral of the Americas?"),
  S("prop_cdx_04", "celebration", "best_for", "Casas del XVI for a romantic celebration overnight in Ciudad Colonial"),
  S("prop_cdx_05", "couples", "best_for", "Romantic Casas del XVI historic houses with private courtyards"),
  S("prop_cdx_06", "group_meeting", "recommend", "Casas del XVI for a small private-house executive retreat"),
  S("prop_cdx_07", "leisure", "best_for", "Best Vignette Collection hotel in Santo Domingo Colonial City"),
  S("prop_cdx_08", "wellness", "recommend", "Casas del XVI with private pools and courtyard calm"),
  S("prop_cdx_09", "business", "where_should", "Where to stay in Zona Colonial at Casas del XVI?"),
  S("prop_cdx_10", "celebration", "recommend", "Casas del XVI wedding weekend lodging in Santo Domingo"),
  S("prop_cdx_11", "leisure", "recommend", "Hotel of restored colonial houses in Ciudad Colonial Santo Domingo"),
  S("prop_cdx_12", "family", "recommend", "Casas del XVI when booking an entire historic house for a family stay"),
  S("prop_cdx_13", "couples", "recommend", "Couples anniversary at Casas del XVI Vignette Collection"),
  S("prop_cdx_14", "group_meeting", "where_should", "Where to host a private board gathering at Casas del XVI?"),
  S("prop_cdx_15", "adventure", "recommend", "Casas del XVI as a base for exploring Zona Colonial landmarks"),
]);
...
export const CALA_SIX_PROPERTY_SCENARIO_MAP = Object.freeze({
  ...
  adp_casas_del_xvi: CASAS_DEL_XVI_SCENARIOS,
