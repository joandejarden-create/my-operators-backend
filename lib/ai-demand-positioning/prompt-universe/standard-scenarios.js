...
export const BOCA_RATON_UPPER_UPSCALE_WATERFRONT_SCENARIOS = Object.freeze([
  ...
  { scenarioId: "std_boca_fam_06", intent: "family", frame: "best_for", query: "Best hotel in Boca Raton with connecting rooms or a suite for a family of five" },
  { scenarioId: "std_boca_fam_07", intent: "family", frame: "recommend", query: "Recommend a Boca Raton hotel for a family that wants kids activities, not just a swimming pool" },
  { scenarioId: "std_boca_fam_08", intent: "family", frame: "where_should", query: "Where should a family stay in Boca Raton if they want easy hotel dining and nearby restaurants?" },
  { scenarioId: "std_boca_fam_09", intent: "family", frame: "best_for", query: "Best family hotel in Palm Beach County for a winter holiday school-break trip" },

  // --- CELEBRATION (5 + 1 hosted anniversary) ---
  ...
  { scenarioId: "std_boca_cel_06", intent: "celebration", frame: "recommend", query: "Recommend a Boca Raton hotel to host an anniversary dinner for family and friends" },
  ...
  { scenarioId: "std_boca_wel_03", intent: "wellness", frame: "best_for", query: "Best hotel in Boca Raton for a spa-focused weekend stay" },
  { scenarioId: "std_boca_wel_04", intent: "wellness", frame: "recommend", query: "Recommend an upscale Boca Raton hotel for a fitness and recovery weekend" },
  { scenarioId: "std_boca_wel_05", intent: "wellness", frame: "where_should", query: "Where should a couple stay in Palm Beach County for spa treatments together?" },
  { scenarioId: "std_boca_wel_06", intent: "wellness", frame: "best_for", query: "Best waterfront hotel in Boca Raton for a quiet wellness stay" },
  { scenarioId: "std_boca_wel_07", intent: "wellness", frame: "recommend", query: "Recommend a luxury wellness escape in the Boca Raton or Palm Beach area" },
  { scenarioId: "std_boca_wel_08", intent: "wellness", frame: "best_for", query: "Best hotel in Boca Raton for a restful, low-key wellness overnight" },
  ...
  { scenarioId: "std_boca_adv_04", intent: "adventure", frame: "best_for", query: "Best hotel in Boca Raton as a base for snorkeling or an ocean activity day" },
  { scenarioId: "std_boca_adv_05", intent: "adventure", frame: "recommend", query: "Recommend a Boca Raton hotel for an active coastal weekend with beach and outdoor time" },
]);
...
/**
 * Downtown Kansas City — Upper Upscale urban / soft-brand / historic boutique markets.
 * Customer leisure label = Leisure Travel (internal key remains leisure).
 */
export const KANSAS_CITY_DOWNTOWN_UPPER_UPSCALE_SCENARIOS = Object.freeze([
  // --- BUSINESS (10) ---
  { scenarioId: "std_kc_biz_01", intent: "business", frame: "best_for", query: "Best upscale hotel in downtown Kansas City for a business trip" },
  { scenarioId: "std_kc_biz_02", intent: "business", frame: "recommend", query: "Recommend a boutique hotel near the Power and Light District for corporate travel" },
  { scenarioId: "std_kc_biz_03", intent: "business", frame: "where_should", query: "Where should I stay in downtown Kansas City for meetings near Bartle Hall?" },
  { scenarioId: "std_kc_biz_04", intent: "business", frame: "best_for", query: "Best full-service hotel in downtown Kansas City with meeting rooms for small groups" },
  { scenarioId: "std_kc_biz_05", intent: "business", frame: "recommend", query: "Upscale hotel in Kansas City for a week of client meetings downtown" },
  { scenarioId: "std_kc_biz_06", intent: "business", frame: "compare", query: "Compare upscale business hotels in downtown Kansas City" },
  { scenarioId: "std_kc_biz_07", intent: "business", frame: "best_for", query: "Best Hilton Honors hotel in downtown Kansas City for business travelers" },
  { scenarioId: "std_kc_biz_08", intent: "business", frame: "where_should", query: "Where to stay near T-Mobile Center and downtown offices in Kansas City?" },
  { scenarioId: "std_kc_biz_09", intent: "business", frame: "recommend", query: "Historic boutique hotel in downtown Kansas City for a senior executive" },
  { scenarioId: "std_kc_biz_10", intent: "business", frame: "best_for", query: "Best design-forward hotel in downtown Kansas City for creative industry professionals" },

  // --- LEISURE (8) ---
  { scenarioId: "std_kc_lei_01", intent: "leisure", frame: "best_for", query: "Best hotel in downtown Kansas City for a weekend city break" },
  { scenarioId: "std_kc_lei_02", intent: "leisure", frame: "where_should", query: "Where should I stay in Kansas City for Power and Light nightlife and dining?" },
  { scenarioId: "std_kc_lei_03", intent: "leisure", frame: "recommend", query: "Recommend an upscale downtown Kansas City hotel for a first-time visit" },
  { scenarioId: "std_kc_lei_04", intent: "leisure", frame: "best_for", query: "Best boutique hotel near the Crossroads Arts District and downtown attractions" },
  { scenarioId: "std_kc_lei_05", intent: "leisure", frame: "compare", query: "Compare downtown Kansas City hotels for a 3-night leisure trip" },
  { scenarioId: "std_kc_lei_06", intent: "leisure", frame: "recommend", query: "Upscale hotel in Kansas City walkable to barbecue, jazz, and entertainment" },
  { scenarioId: "std_kc_lei_07", intent: "leisure", frame: "where_should", query: "Where to stay in downtown Kansas City for streetcar access and sightseeing?" },
  { scenarioId: "std_kc_lei_08", intent: "leisure", frame: "best_for", query: "Best historic hotel in downtown Kansas City for a leisure weekend" },

  // --- COUPLES (7) ---
  { scenarioId: "std_kc_cpl_01", intent: "couples", frame: "best_for", query: "Best romantic hotel in downtown Kansas City for a couples weekend" },
  { scenarioId: "std_kc_cpl_02", intent: "couples", frame: "recommend", query: "Recommend a historic boutique hotel in Kansas City for an anniversary trip" },
  { scenarioId: "std_kc_cpl_03", intent: "couples", frame: "where_should", query: "Where should my partner and I stay downtown for dining and nightlife?" },
  { scenarioId: "std_kc_cpl_04", intent: "couples", frame: "best_for", query: "Best hotel in Kansas City with a speakeasy or cocktail bar for a date night" },
  { scenarioId: "std_kc_cpl_05", intent: "couples", frame: "recommend", query: "Stylish Art Deco hotel in downtown Kansas City for a romantic getaway" },
  { scenarioId: "std_kc_cpl_06", intent: "couples", frame: "compare", query: "Compare romantic boutique hotels in downtown Kansas City" },
  { scenarioId: "std_kc_cpl_07", intent: "couples", frame: "best_for", query: "Best couples hotel near Power and Light for a celebration weekend" },

  // --- GROUP / MEETING (8) ---
  { scenarioId: "std_kc_grp_01", intent: "group_meeting", frame: "best_for", query: "Best hotel in downtown Kansas City for a small corporate retreat" },
  { scenarioId: "std_kc_grp_02", intent: "group_meeting", frame: "recommend", query: "Recommend a downtown Kansas City hotel with meeting space for 30 people" },
  { scenarioId: "std_kc_grp_03", intent: "group_meeting", frame: "where_should", query: "Where should I host a board meeting in downtown Kansas City?" },
  { scenarioId: "std_kc_grp_04", intent: "group_meeting", frame: "best_for", query: "Best boutique hotel near the Kansas City Convention Center for a team offsite" },
  { scenarioId: "std_kc_grp_05", intent: "group_meeting", frame: "recommend", query: "Hotel in downtown Kansas City for a company dinner of 80 to 120 guests" },
  { scenarioId: "std_kc_grp_06", intent: "group_meeting", frame: "best_for", query: "Best venue for a mid-size corporate event in downtown Kansas City" },
  { scenarioId: "std_kc_grp_07", intent: "group_meeting", frame: "where_should", query: "Where to hold a leadership planning session for 20 executives downtown?" },
  { scenarioId: "std_kc_grp_08", intent: "group_meeting", frame: "compare", query: "Compare meeting hotels in downtown Kansas City for a sales kickoff" },

  // --- FAMILY (5) ---
  { scenarioId: "std_kc_fam_01", intent: "family", frame: "best_for", query: "Best family-friendly hotel in downtown Kansas City for a city vacation" },
  { scenarioId: "std_kc_fam_02", intent: "family", frame: "recommend", query: "Recommend a downtown Kansas City hotel for a family with teenagers" },
  { scenarioId: "std_kc_fam_03", intent: "family", frame: "where_should", query: "Where should I stay with kids near T-Mobile Center and downtown attractions?" },
  { scenarioId: "std_kc_fam_04", intent: "family", frame: "best_for", query: "Best hotel in Kansas City for a multigenerational weekend downtown" },
  { scenarioId: "std_kc_fam_05", intent: "family", frame: "compare", query: "Compare family hotels in downtown Kansas City" },

  // --- CELEBRATION (5) ---
  { scenarioId: "std_kc_cel_01", intent: "celebration", frame: "best_for", query: "Best hotel in downtown Kansas City for a birthday celebration dinner and overnight" },
  { scenarioId: "std_kc_cel_02", intent: "celebration", frame: "recommend", query: "Recommend a historic hotel in Kansas City for a rehearsal dinner or small wedding" },
  { scenarioId: "std_kc_cel_03", intent: "celebration", frame: "where_should", query: "Where to host a mid-size celebration for 50 to 150 guests downtown?" },
  { scenarioId: "std_kc_cel_04", intent: "celebration", frame: "best_for", query: "Best upscale downtown Kansas City hotel for a milestone anniversary" },
  { scenarioId: "std_kc_cel_05", intent: "celebration", frame: "recommend", query: "Landmark hotel near Power and Light for a graduation celebration weekend" },

  // --- WELLNESS (3) ---
  { scenarioId: "std_kc_wel_01", intent: "wellness", frame: "best_for", query: "Best hotel in downtown Kansas City with a fitness center for a wellness-focused stay" },
  { scenarioId: "std_kc_wel_02", intent: "wellness", frame: "recommend", query: "Recommend an upscale downtown Kansas City hotel for a restful weekend with gym access" },
  { scenarioId: "std_kc_wel_03", intent: "wellness", frame: "where_should", query: "Where to stay in Kansas City for a quiet overnight with fitness amenities downtown?" },

  // --- ADVENTURE / EXPERIENCES (2) ---
  { scenarioId: "std_kc_adv_01", intent: "adventure", frame: "best_for", query: "Best hotel in downtown Kansas City for exploring jazz, barbecue, and nightlife" },
  { scenarioId: "std_kc_adv_02", intent: "adventure", frame: "recommend", query: "Upscale hotel in Kansas City as a base for arts, Crossroads, and downtown discovery" },
]);

/**
 * Bethesda / Montgomery County (DC metro suburban) — Upper Upscale full-service / upscale.
 * Reusable market pack (not Bethesda Marriott–specific). Same 8-territory ontology as KC/MTY.
 */
export const BETHESDA_MONTGOMERY_UPPER_UPSCALE_SCENARIOS = Object.freeze([
  // --- BUSINESS (10) ---
  { scenarioId: "std_btmd_biz_01", intent: "business", frame: "best_for", query: "Best upscale hotel in Bethesda Maryland for a business trip" },
  { scenarioId: "std_btmd_biz_02", intent: "business", frame: "recommend", query: "Recommend a full-service hotel near NIH in Bethesda for corporate travel" },
  { scenarioId: "std_btmd_biz_03", intent: "business", frame: "where_should", query: "Where should I stay in Bethesda for meetings with easy access to Washington DC?" },
  { scenarioId: "std_btmd_biz_04", intent: "business", frame: "best_for", query: "Best Marriott Bonvoy hotel in Bethesda Maryland for business travelers" },
  { scenarioId: "std_btmd_biz_05", intent: "business", frame: "recommend", query: "Upscale hotel in Montgomery County for a week of client meetings near Rockville Pike" },
  { scenarioId: "std_btmd_biz_06", intent: "business", frame: "compare", query: "Compare upscale business hotels in Bethesda and North Bethesda" },
  { scenarioId: "std_btmd_biz_07", intent: "business", frame: "best_for", query: "Best hotel near Walter Reed for visiting physicians and medical travelers" },
  { scenarioId: "std_btmd_biz_08", intent: "business", frame: "where_should", query: "Where to stay in Bethesda for government and biotech meetings?" },
  { scenarioId: "std_btmd_biz_09", intent: "business", frame: "recommend", query: "Full-service hotel in Bethesda with strong WiFi and meeting rooms for executives" },
  { scenarioId: "std_btmd_biz_10", intent: "business", frame: "best_for", query: "Best upper-upscale hotel in Montgomery County for multi-day corporate travel" },

  // --- LEISURE (8) ---
  { scenarioId: "std_btmd_lei_01", intent: "leisure", frame: "best_for", query: "Best hotel in Bethesda Maryland for a weekend city break" },
  { scenarioId: "std_btmd_lei_02", intent: "leisure", frame: "where_should", query: "Where should I stay in Bethesda for dining and shopping downtown?" },
  { scenarioId: "std_btmd_lei_03", intent: "leisure", frame: "recommend", query: "Recommend an upscale Bethesda hotel as a base for visiting Washington DC" },
  { scenarioId: "std_btmd_lei_04", intent: "leisure", frame: "best_for", query: "Best hotel in Montgomery County for a leisure trip with metro access to DC" },
  { scenarioId: "std_btmd_lei_05", intent: "leisure", frame: "compare", query: "Compare upscale hotels in Bethesda for a 3-night leisure stay" },
  { scenarioId: "std_btmd_lei_06", intent: "leisure", frame: "recommend", query: "Upscale hotel near downtown Bethesda for restaurants and nightlife" },
  { scenarioId: "std_btmd_lei_07", intent: "leisure", frame: "where_should", query: "Where to stay in Bethesda when visiting friends and family in Montgomery County?" },
  { scenarioId: "std_btmd_lei_08", intent: "leisure", frame: "best_for", query: "Best full-service hotel in Bethesda for first-time visitors to the DC suburbs" },

  // --- COUPLES (7) ---
  { scenarioId: "std_btmd_cpl_01", intent: "couples", frame: "best_for", query: "Best romantic hotel in Bethesda Maryland for a couples weekend" },
  { scenarioId: "std_btmd_cpl_02", intent: "couples", frame: "recommend", query: "Recommend an upscale Bethesda hotel with good dining for an anniversary overnight" },
  { scenarioId: "std_btmd_cpl_03", intent: "couples", frame: "where_should", query: "Where should we stay in Bethesda for a quiet couples getaway near DC?" },
  { scenarioId: "std_btmd_cpl_04", intent: "couples", frame: "best_for", query: "Best boutique or lifestyle hotel in Bethesda for a date-night weekend" },
  { scenarioId: "std_btmd_cpl_05", intent: "couples", frame: "recommend", query: "Stylish upscale hotel in Bethesda for a romantic celebration" },
  { scenarioId: "std_btmd_cpl_06", intent: "couples", frame: "compare", query: "Compare romantic hotels in Bethesda and downtown Bethesda" },
  { scenarioId: "std_btmd_cpl_07", intent: "couples", frame: "best_for", query: "Best couples hotel in Montgomery County with restaurant and spa or fitness amenities" },

  // --- GROUP / MEETING (8) ---
  { scenarioId: "std_btmd_grp_01", intent: "group_meeting", frame: "best_for", query: "Best hotel in Bethesda Maryland for a small corporate retreat" },
  { scenarioId: "std_btmd_grp_02", intent: "group_meeting", frame: "recommend", query: "Recommend a Bethesda hotel with meeting space for 30 to 50 people" },
  { scenarioId: "std_btmd_grp_03", intent: "group_meeting", frame: "where_should", query: "Where should I host a board meeting in Bethesda or North Bethesda?" },
  { scenarioId: "std_btmd_grp_04", intent: "group_meeting", frame: "best_for", query: "Best conference hotel in Montgomery County for a team offsite" },
  { scenarioId: "std_btmd_grp_05", intent: "group_meeting", frame: "recommend", query: "Hotel in Bethesda for a company dinner of 80 to 150 guests" },
  { scenarioId: "std_btmd_grp_06", intent: "group_meeting", frame: "best_for", query: "Best venue near Rockville Pike for a mid-size corporate event with lodging" },
  { scenarioId: "std_btmd_grp_07", intent: "group_meeting", frame: "where_should", query: "Where to hold a leadership planning session for 20 executives in Bethesda?" },
  { scenarioId: "std_btmd_grp_08", intent: "group_meeting", frame: "compare", query: "Compare meeting hotels in Bethesda and North Bethesda for a sales kickoff" },

  // --- FAMILY (5) ---
  { scenarioId: "std_btmd_fam_01", intent: "family", frame: "best_for", query: "Best family-friendly hotel in Bethesda Maryland for a weekend visit" },
  { scenarioId: "std_btmd_fam_02", intent: "family", frame: "recommend", query: "Recommend a Bethesda hotel for a family visiting relatives in Montgomery County" },
  { scenarioId: "std_btmd_fam_03", intent: "family", frame: "where_should", query: "Where should a family stay near Bethesda with easy access to Washington DC?" },
  { scenarioId: "std_btmd_fam_04", intent: "family", frame: "best_for", query: "Best hotel in Bethesda for a multigenerational family trip" },
  { scenarioId: "std_btmd_fam_05", intent: "family", frame: "compare", query: "Compare family-friendly upscale hotels in Bethesda" },

  // --- CELEBRATION (5) ---
  { scenarioId: "std_btmd_cel_01", intent: "celebration", frame: "best_for", query: "Best hotel in Bethesda Maryland for a birthday celebration dinner and overnight" },
  { scenarioId: "std_btmd_cel_02", intent: "celebration", frame: "recommend", query: "Recommend a Bethesda hotel for a rehearsal dinner or small wedding" },
  { scenarioId: "std_btmd_cel_03", intent: "celebration", frame: "where_should", query: "Where to host a mid-size celebration for 50 to 150 guests in Bethesda?" },
  { scenarioId: "std_btmd_cel_04", intent: "celebration", frame: "best_for", query: "Best upscale Bethesda hotel for a milestone anniversary" },
  { scenarioId: "std_btmd_cel_05", intent: "celebration", frame: "recommend", query: "Hotel in Montgomery County for a graduation celebration weekend near Bethesda" },

  // --- WELLNESS (3) ---
  { scenarioId: "std_btmd_wel_01", intent: "wellness", frame: "best_for", query: "Best hotel in Bethesda with a fitness center for a wellness-focused stay" },
  { scenarioId: "std_btmd_wel_02", intent: "wellness", frame: "recommend", query: "Recommend an upscale Bethesda hotel with gym and pool for a restful weekend" },
  { scenarioId: "std_btmd_wel_03", intent: "wellness", frame: "where_should", query: "Where to stay in Bethesda for a quiet overnight with fitness amenities?" },

  // --- ADVENTURE / EXPERIENCES (2) ---
  { scenarioId: "std_btmd_adv_01", intent: "adventure", frame: "best_for", query: "Best hotel in Bethesda as a base for exploring Washington DC museums and neighborhoods" },
  { scenarioId: "std_btmd_adv_02", intent: "adventure", frame: "recommend", query: "Upscale hotel in Bethesda for dining, downtown Bethesda, and DC day trips" },
]);

/**
 * Monterrey Valle / San Pedro Garza García — Luxury + Upper Upscale business corridor.
 * Shared pack for JW Marriott Monterrey Valle and The Westin Monterrey Valle.
 */
export const MONTERREY_VALLE_LUXURY_UPPER_UPSCALE_SCENARIOS = Object.freeze([
  // --- BUSINESS (10) ---
  { scenarioId: "std_mtyv_biz_01", intent: "business", frame: "best_for", query: "Best luxury hotel in San Pedro Garza García for a business trip" },
  { scenarioId: "std_mtyv_biz_02", intent: "business", frame: "recommend", query: "Recommend an upscale hotel in Monterrey Valle for corporate meetings" },
  { scenarioId: "std_mtyv_biz_03", intent: "business", frame: "where_should", query: "Where should I stay in Valle Oriente Monterrey for a week of client meetings?" },
  { scenarioId: "std_mtyv_biz_04", intent: "business", frame: "best_for", query: "Best full-service hotel near Punto Valle for business travelers" },
  { scenarioId: "std_mtyv_biz_05", intent: "business", frame: "recommend", query: "Upscale Marriott hotel in San Pedro Garza García with Bonvoy points" },
  { scenarioId: "std_mtyv_biz_06", intent: "business", frame: "compare", query: "Compare luxury and upper-upscale business hotels in Monterrey Valle" },
  { scenarioId: "std_mtyv_biz_07", intent: "business", frame: "best_for", query: "Best hotel in San Pedro for executives visiting Cemex, Banorte, or Valle Oriente offices" },
  { scenarioId: "std_mtyv_biz_08", intent: "business", frame: "where_should", query: "Where to stay in Monterrey for meetings in San Pedro Garza García?" },
  { scenarioId: "std_mtyv_biz_09", intent: "business", frame: "recommend", query: "Hotel in Monterrey Valle with strong WiFi, workspace, and executive amenities" },
  { scenarioId: "std_mtyv_biz_10", intent: "business", frame: "best_for", query: "Best upscale hotel in Nuevo León for a multi-day corporate engagement" },

  // --- LEISURE (8) ---
  { scenarioId: "std_mtyv_lei_01", intent: "leisure", frame: "best_for", query: "Best upscale hotel in San Pedro Garza García for a weekend city break" },
  { scenarioId: "std_mtyv_lei_02", intent: "leisure", frame: "where_should", query: "Where should I stay in Monterrey Valle for shopping and dining?" },
  { scenarioId: "std_mtyv_lei_03", intent: "leisure", frame: "recommend", query: "Recommend a luxury hotel in Monterrey with a pool and mountain views" },
  { scenarioId: "std_mtyv_lei_04", intent: "leisure", frame: "best_for", query: "Best hotel near Fashion Drive and Valle Oriente for leisure travelers" },
  { scenarioId: "std_mtyv_lei_05", intent: "leisure", frame: "compare", query: "Compare upscale hotels in San Pedro Garza García for a 3-night leisure trip" },
  { scenarioId: "std_mtyv_lei_06", intent: "leisure", frame: "recommend", query: "Upscale Monterrey hotel walkable to malls, restaurants, and nightlife in Valle Oriente" },
  { scenarioId: "std_mtyv_lei_07", intent: "leisure", frame: "where_should", query: "Where to stay in Monterrey for a relaxing stay away from the historic center?" },
  { scenarioId: "std_mtyv_lei_08", intent: "leisure", frame: "best_for", query: "Best luxury hotel in Monterrey Valle for first-time visitors" },

  // --- COUPLES (7) ---
  { scenarioId: "std_mtyv_cpl_01", intent: "couples", frame: "best_for", query: "Best romantic hotel in San Pedro Garza García for a couples weekend" },
  { scenarioId: "std_mtyv_cpl_02", intent: "couples", frame: "recommend", query: "Recommend a luxury Monterrey Valle hotel with spa for an anniversary" },
  { scenarioId: "std_mtyv_cpl_03", intent: "couples", frame: "where_should", query: "Where should we stay in Monterrey for a romantic getaway with fine dining?" },
  { scenarioId: "std_mtyv_cpl_04", intent: "couples", frame: "best_for", query: "Best hotel in Valle Oriente with rooftop dining or spa for couples" },
  { scenarioId: "std_mtyv_cpl_05", intent: "couples", frame: "recommend", query: "Upscale hotel in San Pedro for a proposal or anniversary overnight" },
  { scenarioId: "std_mtyv_cpl_06", intent: "couples", frame: "compare", query: "Compare romantic luxury hotels in Monterrey Valle" },
  { scenarioId: "std_mtyv_cpl_07", intent: "couples", frame: "best_for", query: "Best hotel in Monterrey with mountain views and spa for couples" },

  // --- GROUP / MEETING (8) ---
  { scenarioId: "std_mtyv_grp_01", intent: "group_meeting", frame: "best_for", query: "Best hotel in San Pedro Garza García for a corporate retreat" },
  { scenarioId: "std_mtyv_grp_02", intent: "group_meeting", frame: "recommend", query: "Recommend a Monterrey Valle hotel for a team offsite of 40 people" },
  { scenarioId: "std_mtyv_grp_03", intent: "group_meeting", frame: "where_should", query: "Where should I host an executive leadership meeting in Valle Oriente?" },
  { scenarioId: "std_mtyv_grp_04", intent: "group_meeting", frame: "best_for", query: "Best hotel with meeting space near Punto Valle in Monterrey" },
  { scenarioId: "std_mtyv_grp_05", intent: "group_meeting", frame: "recommend", query: "Luxury hotel in San Pedro for a board meeting and overnight stays" },
  { scenarioId: "std_mtyv_grp_06", intent: "group_meeting", frame: "best_for", query: "Best venue in Monterrey Valle for a company event of 100-200 guests" },
  { scenarioId: "std_mtyv_grp_07", intent: "group_meeting", frame: "where_should", query: "Where to hold a sales kickoff in San Pedro Garza García with upscale lodging?" },
  { scenarioId: "std_mtyv_grp_08", intent: "group_meeting", frame: "compare", query: "Compare meeting hotels in Monterrey Valle for a mid-size corporate event" },

  // --- FAMILY (5) ---
  { scenarioId: "std_mtyv_fam_01", intent: "family", frame: "best_for", query: "Best upscale family-friendly hotel in San Pedro Garza García with a pool" },
  { scenarioId: "std_mtyv_fam_02", intent: "family", frame: "recommend", query: "Recommend a Monterrey Valle hotel for a family visiting for a weekend" },
  { scenarioId: "std_mtyv_fam_03", intent: "family", frame: "where_should", query: "Where should a family stay near Valle Oriente malls and restaurants?" },
  { scenarioId: "std_mtyv_fam_04", intent: "family", frame: "best_for", query: "Best hotel in San Pedro for a multigenerational family trip" },
  { scenarioId: "std_mtyv_fam_05", intent: "family", frame: "compare", query: "Compare family-friendly upscale hotels in Monterrey Valle" },

  // --- CELEBRATION (5) ---
  { scenarioId: "std_mtyv_cel_01", intent: "celebration", frame: "best_for", query: "Best hotel in San Pedro Garza García for a birthday celebration dinner and overnight" },
  { scenarioId: "std_mtyv_cel_02", intent: "celebration", frame: "recommend", query: "Recommend a luxury Monterrey Valle venue for a rehearsal dinner or small wedding" },
  { scenarioId: "std_mtyv_cel_03", intent: "celebration", frame: "where_should", query: "Where to host an engagement party in Valle Oriente with hotel rooms for guests?" },
  { scenarioId: "std_mtyv_cel_04", intent: "celebration", frame: "best_for", query: "Best upscale hotel in Monterrey for a milestone celebration" },
  { scenarioId: "std_mtyv_cel_05", intent: "celebration", frame: "recommend", query: "Hotel in San Pedro Garza García for a wedding weekend lodging and events" },

  // --- WELLNESS (3) ---
  { scenarioId: "std_mtyv_wel_01", intent: "wellness", frame: "best_for", query: "Best spa hotel in Monterrey Valle for a wellness weekend" },
  { scenarioId: "std_mtyv_wel_02", intent: "wellness", frame: "recommend", query: "Recommend a San Pedro Garza García hotel with spa, pool, and fitness center" },
  { scenarioId: "std_mtyv_wel_03", intent: "wellness", frame: "where_should", query: "Where to stay in Monterrey for a quiet spa-focused overnight?" },

  // --- ADVENTURE / EXPERIENCES (2) ---
  { scenarioId: "std_mtyv_adv_01", intent: "adventure", frame: "best_for", query: "Best hotel in Monterrey Valle as a base for exploring the city and nearby mountains" },
  { scenarioId: "std_mtyv_adv_02", intent: "adventure", frame: "recommend", query: "Upscale hotel in San Pedro for dining, nightlife, and Valle Oriente discovery" },
]);


import { getCalaSixStandardScenarios } from "./cala-six-scenarios.js";
...
export function getStandardScenarios(market, chainScale) {
  ...
  if (market === "kansas_city_downtown" && chainScale === "upper_upscale") {
    return KANSAS_CITY_DOWNTOWN_UPPER_UPSCALE_SCENARIOS;
  }
  if (market === "bethesda_montgomery" && chainScale === "upper_upscale") {
    return BETHESDA_MONTGOMERY_UPPER_UPSCALE_SCENARIOS;
  }
  if (
    market === "monterrey_valle" &&
    (chainScale === "upper_upscale" || chainScale === "luxury")
  ) {
    return MONTERREY_VALLE_LUXURY_UPPER_UPSCALE_SCENARIOS;
  }
  if (
    (market === "mexico_city_reforma" ||
      market === "cap_cana" ||
      market === "santo_domingo" ||
      market === "cartagena_bocagrande" ||
      market === "bogota_norte") &&
    (chainScale === "luxury" ||
      chainScale === "upper_upscale" ||
      chainScale === "upscale")
  ) {
    return getCalaSixStandardScenarios(market) || [];
  }
  return [];
}
