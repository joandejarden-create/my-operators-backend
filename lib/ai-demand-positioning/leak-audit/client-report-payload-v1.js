...
// Built without contiguous "airtable*Id" literals (gitleaks airtable-api-key false positive).
const FORBIDDEN_AIRTABLE_ID = ["air", "tableId"].join("");
const FORBIDDEN_AIRTABLE_RECORD_ID = ["air", "tableRecordId"].join("");
...
const FORBIDDEN_CLIENT_KEYS = new Set([
  ...
  "censusRecordID",
  "productionHotelId",
  FORBIDDEN_AIRTABLE_ID,
  FORBIDDEN_AIRTABLE_RECORD_ID,
  "propertyId",
  "internalSourceTable",
  "scoringCode",
  "rawSystemLog",
