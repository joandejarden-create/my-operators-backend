...
export const CUSTOMER_TERMINOLOGY_VERSION = "adp_customer_terminology_v3";
export const LEISURE_TRAVEL_CUSTOMER_LABEL = "Leisure Travel";
...
/** Index column when CORE benchmark is not customer-numeric yet — never reuse benchmark copy in subject column. */
export const INDEX_UNAVAILABLE_LABEL = "Not yet available";
export const INDEX_UNAVAILABLE_LINE1 = "Not yet";
export const INDEX_UNAVAILABLE_LINE2 = "available";
/** Subject AI Presence missing for a territory — not a benchmark certification statement. */
export const SUBJECT_PRESENCE_UNAVAILABLE_LABEL = "Not available";
export const SUBJECT_PRESENCE_UNAVAILABLE_LINE1 = "Not";
export const SUBJECT_PRESENCE_UNAVAILABLE_LINE2 = "available";
