 ...
 * Index = (your presence rate / declared comp set average presence rate) × 100.
 * 100 = parity with core comp set, >100 = outperforming, <100 = underperforming.
 * Suppressed when comp benchmark is too thin (low avg comp rate) or index would exceed cap.
 */
