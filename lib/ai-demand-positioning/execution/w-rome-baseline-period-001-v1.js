 ...
 * Hotel-instance execution; uses certified peer pack + generic profile scenarios.
 *
 *   Cost: ~20 scenarios × available providers (cap $8).
 */
...
export const W_ROME_COST_CAP_USD = 8;
