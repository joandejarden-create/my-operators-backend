...
/** Boutique / historic Colonial City CORE — do not inherit JW Piantini set. */
export const CASAS_DEL_XVI_ROLE_OVERRIDES = roles({
  kimpton_las_mercedes_santo_domingo: bizLeisureCore(false),
  billini_hotel_santo_domingo: {
    [TRAVELER_INTENTS.BUSINESS]: CORE,
    [TRAVELER_INTENTS.LEISURE]: CORE,
    [TRAVELER_INTENTS.COUPLES]: CORE,
    [TRAVELER_INTENTS.FAMILY]: SEC,
    [TRAVELER_INTENTS.GROUP_MEETING]: CORE,
    [TRAVELER_INTENTS.WELLNESS]: SEC,
    [TRAVELER_INTENTS.ADVENTURE]: CORE,
    [TRAVELER_INTENTS.CELEBRATION]: CORE,
  },
  hodelpa_nicolas_de_ovando: {
    [TRAVELER_INTENTS.BUSINESS]: CORE,
    [TRAVELER_INTENTS.LEISURE]: CORE,
    [TRAVELER_INTENTS.COUPLES]: CORE,
    [TRAVELER_INTENTS.FAMILY]: SEC,
  ...
  jw_marriott_santo_domingo: {
    ...
    [TRAVELER_INTENTS.FAMILY]: SEC,
    [TRAVELER_INTENTS.GROUP_MEETING]: SEC,
    [TRAVELER_INTENTS.WELLNESS]: COND,
    [TRAVELER_INTENTS.ADVENTURE]: COND,
    [TRAVELER_INTENTS.CELEBRATION]: COND,
  },
  crowne_plaza_santo_domingo: secondaryMostly(),
  holiday_inn_santo_domingo: secondaryMostly(),
  hilton_santo_domingo: secondaryMostly(),
  radisson_santo_domingo: secondaryMostly(),
});
...
export const CALA_SIX_ROLE_OVERRIDES = Object.freeze({
  ...
  adp_casas_del_xvi: CASAS_DEL_XVI_ROLE_OVERRIDES,
...
export const CALA_SIX_STABILIZED_CORE_IDS = Object.freeze({
  ...
  adp_casas_del_xvi: {
    [TRAVELER_INTENTS.BUSINESS]: [
      "kimpton_las_mercedes_santo_domingo",
      "billini_hotel_santo_domingo",
      "hodelpa_nicolas_de_ovando",
      "intercontinental_real_santo_domingo",
    ],
