...
export const CORE_REMEDIATION = Object.freeze({
  ...
  leisure: {
    ...
    added: [],
    rationale: "Colony is a historic inn, not a resort; keep for Couples, not Leisure Travel CORE.",
  },
...
export function coreRelationshipAudit() {
  ...
  row("leisure", "colony_hotel_delray", "OBSERVED", "DOWNGRADE", "Historic inn, not resort positioning for Leisure Travel CORE.", { geo: "HIGH", pos: "MEDIUM", type: "LOW", terr: "MEDIUM" });
