...
export const CURRENTLY_CERTIFIED_TERRITORIES = Object.freeze([
  { propertyId: "adp_renaissance_times_square", intent: TRAVELER_INTENTS.LEISURE, label: territoryLabelForIntent(TRAVELER_INTENTS.LEISURE) },
...
export const PROVIDER_CONCENTRATION_AFFECTED = Object.freeze([
  ...
  { propertyId: "adp_cambridge_beaches_bermuda", intent: TRAVELER_INTENTS.LEISURE, label: territoryLabelForIntent(TRAVELER_INTENTS.LEISURE) },
  ...
  { propertyId: "adp_now_now_noho", intent: TRAVELER_INTENTS.LEISURE, label: territoryLabelForIntent(TRAVELER_INTENTS.LEISURE) },
