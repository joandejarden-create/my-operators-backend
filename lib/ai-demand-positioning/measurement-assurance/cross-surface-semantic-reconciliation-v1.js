...
import {
  assertTopAlternativeMatchesOverallLeader,
  deriveTopObservedAiAlternative,
} from "../customer/top-observed-ai-alternative-v1.js";
import {
...
export function reconcileTopAlternativeVsOverview(observations, scenarios, propertyProfile, payload = null) {
  ...
  const topAltDerived = deriveTopObservedAiAlternative(obs, propertyProfile, {
    overallRanking: overall,
    scenarios,
  });
  const topAlt = topAltDerived?.topObservedAlternative || null;
