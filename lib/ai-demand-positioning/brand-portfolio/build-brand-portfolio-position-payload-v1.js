...
const CUSTOMER_COPY = Object.freeze({
  [BRAND_PORTFOLIO_STATUS.NOT_CONFIGURED]: Object.freeze({
    statusLabel: "Brand & Portfolio not shown",
    headline: "Brand & Portfolio not shown",
    body: "Brand & Portfolio benchmarking is not shown for this period because the governed affiliation and peer path are not yet resolved for display.",
    secondary: null,
  }),
  ...
  [BRAND_PORTFOLIO_STATUS.AWAITING_FIRST_MONITORING]: Object.freeze({
    statusLabel: "Brand & Portfolio measurement in progress",
    headline: "Brand & Portfolio measurement in progress",
    body: "Brand & Portfolio insights will appear here after the first certified portfolio monitoring cycle for this hotel.",
  ...
  [BRAND_PORTFOLIO_STATUS.ASSURANCE_REVIEW_REQUIRED]: Object.freeze({
    statusLabel: "Brand & Portfolio under review",
    headline: "Brand & Portfolio under review",
    body: "Brand & Portfolio insights will appear here once this period’s results are cleared for display.",
    secondary: null,
  }),
  [BRAND_PORTFOLIO_STATUS.EXCEPTION_SUPPRESSED]: Object.freeze({
    statusLabel: "Brand & Portfolio not shown",
    headline: "Brand & Portfolio not shown",
    body: "Brand & Portfolio benchmarking is not shown for this period because the governed peer set does not yet meet the minimum comparability requirement.",
    secondary: null,
  }),
});
