...
export const LENS_LABEL_RECOMMENDATION_V1 = Object.freeze({
  ...
  ihg: {
    recommendedCustomerLabel: "IHG One Rewards",
    alternativesConsidered: ["IHG Portfolio", "Vignette Collection"],
    rationale:
      "IHG One Rewards is the traveler/owner-recognized loyalty frame; do not use Vignette as the primary lens label.",
    promptDefaultConstraint: "IHG",
    promptLoyaltyConstraint: "IHG One Rewards",
...
export const ADP_PROPERTY_PORTFOLIO_MAPPING_V1 = Object.freeze({
  ...
  adp_w_rome: Object.freeze({
    ...
    lenses: Object.freeze([
      Object.freeze({
        ...
        loyaltyPhrase: "Marriott Bonvoy",
        ecosystemId: "marriott_bonvoy",
        notes: "PRIMARY — Marriott Bonvoy loyalty ecosystem; peer pack certified separately",
      }),
      Object.freeze({
        lensId: "w_hotels",
        portfolioType: PORTFOLIO_TYPES.HARD_BRAND_PORTFOLIO,
  ...
  adp_casas_del_xvi: Object.freeze({
    ...
    profileEvidence: Object.freeze({
      ...
      affiliation: "Vignette Collection",
      parentCompany: "IHG Hotels & Resorts",
      officialBrandDomain: "ihg.com",
    }),
    defaultLensId: "ihg_one_rewards",
    lenses: Object.freeze([
      Object.freeze({
        lensId: "ihg_one_rewards",
        portfolioType: PORTFOLIO_TYPES.LOYALTY_ECOSYSTEM,
        label: "IHG One Rewards",
        status: PORTFOLIO_LENS_STATUS.DEFAULT,
        constraintPhrase: "IHG",
        loyaltyPhrase: "IHG One Rewards",
        ecosystemId: "ihg_one_rewards",
        notes: "PRIMARY — IHG One Rewards within Greater Santo Domingo (all IHG brands)",
      }),
      Object.freeze({
        lensId: "vignette_collection",
        portfolioType: PORTFOLIO_TYPES.COLLECTION_PORTFOLIO,
        label: "Vignette Collection",
        status: PORTFOLIO_LENS_STATUS.OPTIONAL_FUTURE,
        constraintPhrase: "Vignette Collection",
        notes: "SECONDARY future soft-brand drill-down — not primary BPP lens",
      }),
    ]),
    sectionMode: "BRAND_PORTFOLIO_POSITION",
  }),
