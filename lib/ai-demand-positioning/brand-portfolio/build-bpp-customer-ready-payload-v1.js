...
import { computeBrandPortfolioMetricsV1 } from "./brand-portfolio-first-cycle-metrics-v1.js";
...
} from "./adp-bpp-canonical-evidence-set-v1.js";
...
export function buildBppCustomerReadyPayloadFromPeriod({
  ...
  payload = attachCanonicalEvidenceToBppPayload(payload, evidenceSet);
