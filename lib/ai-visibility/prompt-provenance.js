...
export const EXISTING_OBSERVED_SIGNAL_SOURCES = Object.freeze([
  ...
  },
  {
    ...
    METHOD: "Google Ads search volume live + SERP PAA/related; budget-capped sample 2026-08-17",
    SIGNALS_FOUND: 10,
    DISTINCT_THEMES: 6,
    USABLE: "FILE_STORE_ONLY",
    LIVE_MONITORING: "NO",
    BLOCKER: null,
    NOTE: "actual_cost_usd 0.282. Phase remaining 1.718 unused on purpose. Account funding is not a project budget.",
  },
  {
