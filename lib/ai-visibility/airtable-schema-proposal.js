...
export const AI_VISIBILITY_PROMPT_FIELD_SPECS = [
  ...
  },
  {
    ...
    type: "singleSelect",
    schemaApply: false,
    provenanceRole: "operational",
    description:
      "Operational SSOT origin. Proposed only — V1 activation did not apply Airtable schema or write prompt rows. File-store overlay is live provenance.",
    options: {
  ...
  {
    name: "Demand Signal Type",
    type: "singleLineText",
    schemaApply: false,
    provenanceRole: "deferred",
  },
  {
    name: "Demand Geography",
    type: "singleLineText",
    schemaApply: false,
    provenanceRole: "operational",
  },
  ...
  },
  {
    ...
    schemaApply: false,
    provenanceRole: "deferred",
    description: "Required before assigning HIGH/MEDIUM/LOW demand tier. Lives in file store for V1.",
  },
  {
    name: "Derived From Observed Prompt ID",
    type: "singleLineText",
    schemaApply: false,
    provenanceRole: "operational",
  },
  {
    name: "Derived From Demand Signal ID",
    type: "singleLineText",
    schemaApply: false,
    provenanceRole: "deferred",
  },
  ...
  },
  {
    ...
    schemaApply: false,
    provenanceRole: "deferred",
    description: "Future repeated-testing hook. Scheduler remains off. File-store metadata only in V1.",
    options: {
...
export const AI_VISIBILITY_PROMPT_OPERATIONAL_PROVENANCE_FIELD_NAMES = Object.freeze([
  "Prompt Origin",
  "Origin Source Type",
  "Observed Theme",
  "Demand Tier",
...
export const AI_VISIBILITY_PROMPT_DEFERRED_PROVENANCE_FIELD_NAMES = Object.freeze([
  "Origin Source Name",
  "Origin Source Reference",
  "Observed Query",
  "Demand Signal Type",
  "Demand Evidence Count",
  "Demand Methodology",
  "Derived From Demand Signal ID",
  "Owner Intent Subtheme",
  "Provenance Notes",
  "Created By Method",
  "Last Provenance Review At",
  "Sampling Priority",
]);
...
export function getPromptOperationalProvenanceFieldSpecs() {
  return AI_VISIBILITY_PROMPT_FIELD_SPECS.filter(
    (f) => f.provenanceRole === "operational"
  );
}
