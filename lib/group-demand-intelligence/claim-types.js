...
export const OPPORTUNITY_TYPE = Object.freeze({
  ...
  /**
   * Fixed meeting venue (campus / convention / arena) with open or unclear housing.
   * Distinct from full-event relocation RFP — guestrooms, VIP, overflow, ancillary.
   */
  FIXED_VENUE_OPEN_HOUSING: "FIXED_VENUE_OPEN_HOUSING",
...
export const OPPORTUNITY_TYPE_LABEL = Object.freeze({
  ...
  FIXED_VENUE_OPEN_HOUSING: "Fixed Venue / Open Housing",
  REACTIVATION: "Reactivation",
...
export const VENUE_SOURCING_STATUS = Object.freeze({
  ...
  /** Destination city/region not yet announced — research signal, not auto-TRUE */
  DESTINATION_TBD: "DESTINATION_TBD",
  /** Accommodations / room block not yet announced */
  HOUSING_PENDING: "HOUSING_PENDING",
  /** Registration open but host hotel unannounced */
  REGISTRATION_OPEN_HOTEL_UNANNOUNCED: "REGISTRATION_OPEN_HOTEL_UNANNOUNCED",
...
export const VENUE_SOURCING_STATUS_LABEL = Object.freeze({
  ...
  DESTINATION_TBD: "Destination TBD",
  HOUSING_PENDING: "Housing Pending",
  REGISTRATION_OPEN_HOTEL_UNANNOUNCED: "Registration Open / Hotel Unannounced",
...
/**
 * Future-cycle commercial states for event-series expansion (not auto-TRUE).
 */
export const FUTURE_CYCLE_STATE = Object.freeze({
...
export const FUTURE_CYCLE_STATE_LABEL = Object.freeze({
  KNOWN_DATE: "Known Date",
  KNOWN_YEAR: "Known Year",
  DESTINATION_TBD: "Destination TBD",
  VENUE_TBD: "Venue TBD",
  HOTEL_TBD: "Hotel TBD",
  HOUSING_PENDING: "Housing Pending",
  FUTURE_UNCONFIRMED: "Future Unconfirmed",
  CLOSED: "Closed",
});
