...
Your job is to FIND real event / group-demand candidates from evidence.
...
1) a real named event / meeting / congress / forum / feria / conferencia / incentivo / retiro / buyout / assembly
2) a date OR named cycle/year (2026/2027) OR explicit save-the-date
...
One page may contain MULTIPLE events — emit multiple candidates.
Prefer schema.org/Event or JSON-LD fields when present.

Return JSON: { "candidates": [ {...} ] }
Candidate fields (omit only if unsupported):
eventName, organization, opportunityType (PRIMARY_PURSUIT|OVERFLOW_HOUSING|FUTURE_CYCLE|REACTIVATION),
