...
/**
 * Derive explicit capabilities from token payload.
 ...
 */
export function resolveGdiShareCapabilities(payload) {
...
export function verifyGdiShareCapability(
  ...
  const capabilities = resolveGdiShareCapabilities(payload);
