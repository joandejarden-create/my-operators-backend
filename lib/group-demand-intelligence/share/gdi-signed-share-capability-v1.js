...
export function sanitizeOpportunityForShare(opp) {
  ...
  return {
    ...
    sources: (opp.sources || []).slice(0, 12).map((s) => ({
      ...
      date: s.date || null,
      url: s.url,
      supportsFact: s.supportsFact || s.whatItSupports || null,
      whatItSupports: s.whatItSupports || s.supportsFact || null,
      claimKind: s.claimKind,
    })),
    // Private Events V1.6 customer fields
    demandFamily: opp.demandFamily || null,
    demandFamilyLabel: opp.demandFamilyLabel || null,
    demandSignalType: opp.demandSignalType || null,
    demandSignalTypeLabel: opp.demandSignalTypeLabel || null,
    peVenueId: opp.peVenueId || null,
    peSignalId: opp.peSignalId || null,
    hotelVenueFitId: opp.hotelVenueFitId || null,
    venueId: opp.venueId || opp.peVenueId || null,
    venueName: opp.venueName || null,
    venueAddress: opp.venueAddress || null,
    venueCity: opp.venueCity || null,
    venueRegion: opp.venueRegion || null,
    venueType: opp.venueType || null,
    venueCapacity: opp.venueCapacity ?? opp.maxCapacity ?? null,
    distanceMiles: opp.distanceMiles ?? null,
    distanceKm: opp.distanceKm ?? null,
    driveTimeMinutes: opp.driveTimeMinutes ?? null,
    onSiteLodgingStatus: opp.onSiteLodgingStatus || null,
    onSiteLodgingStatusLabel: opp.onSiteLodgingStatusLabel || null,
    venueLodgingStatus: opp.venueLodgingStatus || opp.onSiteLodgingStatus || null,
    onSiteGuestrooms: opp.onSiteGuestrooms ?? null,
    eventActivityEvidenceStatus: opp.eventActivityEvidenceStatus || null,
    eventActivityEvidenceStatusLabel: opp.eventActivityEvidenceStatusLabel || null,
    partnerStatus: opp.partnerStatus || null,
    partnerStatusLabel: opp.partnerStatusLabel || null,
    productFit: opp.productFit || null,
    productFitLabel: opp.productFitLabel || null,
    lodgingCatchmentFit: opp.lodgingCatchmentFit || null,
    lodgingCatchmentFitLabel: opp.lodgingCatchmentFitLabel || null,
    partnershipPotential: opp.partnershipPotential || null,
    partnershipPotentialLabel: opp.partnershipPotentialLabel || null,
    lodgingCapturePotential: opp.lodgingCapturePotential || null,
    lodgingCapturePotentialLabel: opp.lodgingCapturePotentialLabel || null,
    fitRationale: opp.fitRationale || null,
    commercialContactPath: opp.commercialContactPath || null,
    commercialContactPathLabel: opp.commercialContactPathLabel || null,
    contactDisplayMode: opp.contactDisplayMode || null,
    contactOfficialUrl: opp.contactOfficialUrl || null,
    officialSourceUrls: (opp.officialSourceUrls || []).slice(0, 8),
    partnershipStatusDisplay: opp.partnershipStatusDisplay || null,
    standingOpportunity: opp.standingOpportunity === true,
    eventDateDisplay: opp.eventDateDisplay || null,
    detailLayout: opp.detailLayout || null,
    whoPrimaryReason: opp.whoPrimaryReason || null,
