...
const FIELD_ALIASES = {
  ...
  "Hotel Service Model": {
    ...
    "lifestyle / select-service": "Lifestyle / Boutique",
  ...
  "Building Type": {
    ...
    "historic / adaptive reuse": "Historic / Renovated",
  ...
  "Preferred Deal Structure": {
    "franchise + 3rd party mgmt.": "Brand + Third-Party Management (Combined)",
    "franchise + 3rd party management": "Brand + Third-Party Management (Combined)",
  ...
  "Target Guest Segment": {
    ...
    "urban creative/leisure, corporate weekday demand": "Bleisure (Business + Leisure)",
...
function inferAmenitiesFromText(text) {
  ...
  if (!out.length) return ["Other Amenities (specify)"];
  return out;
}
