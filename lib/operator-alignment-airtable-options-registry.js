...
export const OAS_AUDIT_FIELD_SPECS = [
  ...
  {
    tableKey: "mp",
    fieldName: Planned.OAS_DEAL_MP_FIELD_NAMES.preferredOperatorManagementStructure,
    plannedOptions: Planned.OAS_PREFERRED_OPERATOR_MANAGEMENT_STRUCTURE_OPTIONS,
  },
  // SI — Phase 5B
  { tableKey: "si", fieldName: Planned.OAS_DEAL_SI_FIELD_NAMES.operatorStructureIntent, plannedOptions: Planned.OAS_PREFERRED_OPERATOR_MANAGEMENT_STRUCTURE_OPTIONS },
