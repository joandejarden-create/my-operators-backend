...
export const MISSION_OBJECTIVE_HBX_PHASE1_EXISTING_MATCH_HIGH_APPLY_V1 =
  "hbx-phase1-existing-match-high-apply-v1";
export const MISSION_OBJECTIVE_HBX_CENSUS_SCHEMA_AND_IDENTITY_LINKAGE_V1 =
  "hbx-census-schema-and-identity-linkage-v1";
export const MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1 =
  "full-cala-15k-census-shell-insert-v1";
export const MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1_COLOMBIA_BATCH =
  "full-cala-15k-census-shell-insert-v1-colombia-batch";
export const MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1_MEXICO_BATCH_1 =
  "full-cala-15k-census-shell-insert-v1-mexico-batch-1";
export const MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1_MEXICO_BATCH_2 =
  "full-cala-15k-census-shell-insert-v1-mexico-batch-2";
export const MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1_MEXICO_BATCH_3 =
  "full-cala-15k-census-shell-insert-v1-mexico-batch-3";
export const MISSION_OBJECTIVE_FULL_CALA_15K_SHELL_FORMAT_SOURCE_BRAND_BACKFILL_V1 =
...
export function resolveMissionObjective(objective) {
  ...
  if (o === MISSION_OBJECTIVE_HBX_PHASE1_EXISTING_MATCH_HIGH_APPLY_V1) {
    return MISSION_OBJECTIVE_HBX_PHASE1_EXISTING_MATCH_HIGH_APPLY_V1;
  }
  if (o === MISSION_OBJECTIVE_HBX_CENSUS_SCHEMA_AND_IDENTITY_LINKAGE_V1) {
    return MISSION_OBJECTIVE_HBX_CENSUS_SCHEMA_AND_IDENTITY_LINKAGE_V1;
  }
  if (
    o === MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1 ||
    o === MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1_COLOMBIA_BATCH ||
    o === MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1_MEXICO_BATCH_1 ||
    o === MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1_MEXICO_BATCH_2 ||
    /^full-cala-15k-census-shell-insert-v1-mexico-batch-\d+$/.test(o)
  ) {
    return MISSION_OBJECTIVE_FULL_CALA_15K_CENSUS_SHELL_INSERT_V1;
  }
  if (o === MISSION_OBJECTIVE_FULL_CALA_15K_SHELL_FORMAT_SOURCE_BRAND_BACKFILL_V1) {
    return MISSION_OBJECTIVE_FULL_CALA_15K_SHELL_FORMAT_SOURCE_BRAND_BACKFILL_V1;
  }
