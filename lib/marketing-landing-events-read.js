...
export function aggregateLandingEvents(events, opts = {}) {
  ...
  const base = {
    ...
    // Dashboard (audience, acquisition, popular pages, geo, device) spans all
    // public surfaces. Funnel/video stay landing-scoped above.
    dashboard: buildLandingDashboard(events),
