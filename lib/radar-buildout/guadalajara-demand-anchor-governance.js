/**
 * Governance defaults for Guadalajara demand anchor candidates.
 */
import {
...
export function applyGuadalajaraGovernanceDefaults(point, overrides = {}) {
  ...
  return applyIslandGovernanceDefaults("Mexico", point, {
    ...
    projectRelevanceLogic:
      ...
      `Guadalajara build — ${submarket} ${pointType} anchor for hotel demand.`,
  });
}

export const GUADALAJARA_SUBMARKETS = ["Centro","Zapopan","Tlaquepaque","Expo / Andares","Airport Corridor","Other"];
