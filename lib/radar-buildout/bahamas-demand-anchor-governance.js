/**
 * Governance defaults for Bahamas countrywide demand anchor candidates.
 */
...
export function applyBahamasGovernanceDefaults(point, overrides = {}) {
  ...
  return {
    ...
    projectRelevanceLogic:
      ...
      `Bahamas countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
    dealSpecificNotes: overrides.dealSpecificNotes || "",
  };
}

export const BAHAMAS_SUBMARKETS = [
