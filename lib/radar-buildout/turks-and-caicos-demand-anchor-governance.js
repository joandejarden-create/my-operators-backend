/**
 * Governance defaults for Turks & Caicos countrywide demand anchor candidates.
 */
...
export function applyTurksAndCaicosGovernanceDefaults(point, overrides = {}) {
  ...
  return {
    ...
    projectRelevanceLogic:
      ...
      `Turks & Caicos countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
    dealSpecificNotes: overrides.dealSpecificNotes || "",
  };
}

export const TURKS_AND_CAICOS_SUBMARKETS = ["Providenciales", "Grand Turk", "Other"];
