/**
 * Governance defaults for Guadeloupe Countrywide demand anchor candidates.
 */
import {
...
export function applyGuadeloupeGovernanceDefaults(point, overrides = {}) {
  ...
  return applyIslandGovernanceDefaults("Guadeloupe", point, {
    ...overrides,
    ...
    projectRelevanceLogic:
      ...
      `Guadeloupe Countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
  });
}

export const GUADELOUPE_SUBMARKETS = ["Pointe-à-Pitre","Grande-Terre","Basse-Terre","Other"];
