/**
 * Governance defaults for Jamaica countrywide demand anchor candidates.
 */
...
const POINT_TYPE_USE_CASE_TAGS = {
  ...
  "Mixed-Use Development": ["Mixed-Use / Growth", "Cruise / Port"],
...
export function applyJamaicaGovernanceDefaults(point, overrides = {}) {
  ...
  return {
    ...
    projectRelevanceLogic:
      ...
      `Jamaica countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
    dealSpecificNotes: overrides.dealSpecificNotes || "",
  };
}

export const JAMAICA_SUBMARKETS = [
  "Montego Bay",
  "Ocho Rios",
  "Negril",
  "Kingston",
