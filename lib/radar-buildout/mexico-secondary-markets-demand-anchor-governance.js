/**
 * Governance defaults for Mexico Secondary Markets demand anchor candidates.
 */
import {
...
export function applyMexicoSecondaryMarketsGovernanceDefaults(point, overrides = {}) {
  ...
  return applyIslandGovernanceDefaults("Mexico", point, {
    ...
    projectRelevanceLogic:
      ...
      `Mexico Secondary Markets build — ${submarket} ${pointType} anchor for hotel demand.`,
  });
}

export const MEXICO_SECONDARY_MARKETS_SUBMARKETS = ["Oaxaca", "Querétaro", "Guanajuato", "Mazatlán"];
