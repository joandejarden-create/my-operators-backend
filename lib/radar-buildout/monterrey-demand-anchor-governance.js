/**
 * Governance defaults for Monterrey demand anchor candidates.
 */
import {
...
export function applyMonterreyGovernanceDefaults(point, overrides = {}) {
  ...
  return applyIslandGovernanceDefaults("Mexico", point, {
    ...
    projectRelevanceLogic:
      ...
      `Monterrey build — ${submarket} ${pointType} anchor for hotel demand.`,
  });
}

export const MONTERREY_SUBMARKETS = ["San Pedro","Centro","Santa Catarina","Airport Corridor","Valle Oriente","Other"];
