/**
 * Governance defaults for Curaçao countrywide demand anchor candidates.
 */
...
export function applyCuracaoGovernanceDefaults(point, overrides = {}) {
  ...
  return {
    ...
    projectRelevanceLogic:
      ...
      `Curaçao countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
    dealSpecificNotes: overrides.dealSpecificNotes || "",
  };
}

export const CURACAO_SUBMARKETS = [
