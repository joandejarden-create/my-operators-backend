/**
 * Governance defaults for Martinique Countrywide demand anchor candidates.
 */
import {
...
export function applyMartiniqueGovernanceDefaults(point, overrides = {}) {
  ...
  return applyIslandGovernanceDefaults("Martinique", point, {
    ...overrides,
    ...
    projectRelevanceLogic:
      ...
      `Martinique Countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
  });
}

export const MARTINIQUE_SUBMARKETS = ["Fort-de-France","South Coast","North Atlantic","Other"];
