/**
 * Governance defaults for Bonaire Countrywide demand anchor candidates.
 */
import {
...
export function applyBonaireGovernanceDefaults(point, overrides = {}) {
  ...
  return applyIslandGovernanceDefaults("Bonaire", point, {
    ...overrides,
    ...
    projectRelevanceLogic:
      ...
      `Bonaire Countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
  });
}

export const BONAIRE_SUBMARKETS = ["Kralendijk","Rincon","Washington Slagbaai","Other"];
