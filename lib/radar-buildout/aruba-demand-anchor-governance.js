/**
 * Governance defaults for Aruba countrywide demand anchor candidates.
 */
...
export function applyArubaGovernanceDefaults(point, overrides = {}) {
  ...
  return {
    ...
    projectRelevanceLogic:
      ...
      `Aruba countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
    dealSpecificNotes: overrides.dealSpecificNotes || "",
  };
}

export const ARUBA_SUBMARKETS = [
