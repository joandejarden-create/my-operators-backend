/**
 * Governance defaults for Barbados countrywide demand anchor candidates.
 */
...
export function applyBarbadosGovernanceDefaults(point, overrides = {}) {
  ...
  return {
    ...
    projectRelevanceLogic:
      ...
      `Barbados countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
    dealSpecificNotes: overrides.dealSpecificNotes || "",
  };
}

export const BARBADOS_SUBMARKETS = ["Bridgetown", "West Coast", "South Coast", "Other"];
