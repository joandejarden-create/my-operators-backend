/**
 * Governance defaults for Haiti Countrywide demand anchor candidates.
 */
import {
...
export function applyHaitiGovernanceDefaults(point, overrides = {}) {
  ...
  return applyIslandGovernanceDefaults("Haiti", point, {
    ...overrides,
    ...
    projectRelevanceLogic:
      ...
      `Haiti Countrywide build — ${submarket} ${pointType} anchor for hotel demand.`,
  });
}

export const HAITI_SUBMARKETS = ["Port-au-Prince","Cap-Haïtien","Jacmel","Other"];
