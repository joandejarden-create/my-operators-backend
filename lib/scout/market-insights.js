...
function buildInsightsFromContext(ctx) {
  ...
  } else if (ctx.hpcEnabled && ctx.warnings) {
    ctx.warnings.push(
      "SCOUT_HPC_SAFE_DEGRADATION: chain_scale_gap insights suppressed (Chain Scale absent on HPC)."
    );
  }
