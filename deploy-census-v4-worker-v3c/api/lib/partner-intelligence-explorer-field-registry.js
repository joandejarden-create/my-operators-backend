...
/**
 * Pilot / quality-baseline operators (Operator Explorer golden bar).
 * Keep aligned with lib/partner-intelligence/operator-explorer-quality-baseline.js
 * and docs/data-intelligence/operator-explorer-arbor-hotel-equities-quality-baseline.md
 */
...
export const PILOT_BRANDS = {
  ...
  curioCollection: {
    ...
    loyaltyProgram: "hiltonHonors",
    includeSubpaths: ["fdd", "press", "development", "website", "inbox"],
    brandSlug: "curio",
    region: "Global",
    explorerUrl: "/brand-explorer-combined.html?brand=Curio%20Collection%20by%20Hilton",
  },
};
...
/** Arbor + Hotel Equities — suggested public source seeds (not auto-created) */
export const PILOT_OPERATOR_SOURCE_CANDIDATES = {
  ...
  hotelEquities: [
    {
      sourceTitle: "Hotel Equities — Official Website",
      sourceUrl: "https://www.hotelequities.com/",
      sourceType: "Website Capture",
      sourceOrigin: "Public Web",
      suggestedQuality: "Medium",
    },
    {
      ...
      sourceUrl: "https://www.hotelequities.com/services",
      sourceType: "Website Capture",
      sourceOrigin: "Public Web",
      suggestedQuality: "Medium",
    },
