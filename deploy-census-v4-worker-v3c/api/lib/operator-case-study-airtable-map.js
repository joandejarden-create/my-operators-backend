...
import { normalizeOperatorCaseStudyHotelTypeValue } from "../../lib/operator-explorer/operator-case-study-hotel-type-normalize.js";
...
export function mapAirtableRowToCaseStudyDetail(row) {
  ...
  return {
    ...
    hotel_type: normalizeOperatorCaseStudyHotelTypeValue(pickField(row, "hotel_type")),
