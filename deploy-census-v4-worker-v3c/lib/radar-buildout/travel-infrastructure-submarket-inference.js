...
const CITY_EXACT_MAP = {
  ...
  "Dominican Republic": {
    ...
    maimon: { submarket: "Puerto Plata / Sosúa / Cabarete", confidence: "High" },
    maimón: { submarket: "Puerto Plata / Sosúa / Cabarete", confidence: "High" },
    marapica: { submarket: "Puerto Plata / Sosúa / Cabarete", confidence: "Medium" },
    "costa dorada": { submarket: "Puerto Plata / Sosúa / Cabarete", confidence: "Medium" },
    dajabon: { submarket: "Other", confidence: "Medium" },
    dajabón: { submarket: "Other", confidence: "Medium" },
