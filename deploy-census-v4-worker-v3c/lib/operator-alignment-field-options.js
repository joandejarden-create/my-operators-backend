...
import {
  ...
  MIXED_USE_SELECT_FORM_TO_AIRTABLE,
} from "./mixed-use-intake-field-options.js";
...
/** Phase 5B P1 — Market Performance operator structure (distinct from SI Preferred Management Structure). */
export const OAS_PREFERRED_OPERATOR_MANAGEMENT_STRUCTURE_OPTIONS = [
...
export const OAS_DEAL_SI_FIELD_NAMES = {
  ...
  operatorStructureIntent: "Operator Structure Intent",
};

/** Market - Performance deal fields for Operator Alignment (Phase 5B P1). */
export const OAS_DEAL_MP_FIELD_NAMES = {
  preferredOperatorManagementStructure: "Preferred Operator Management Structure",
};

export const OAS_DEAL_DEALS_FIELD_NAMES = {
  /** OAS F&B source of truth — live on Deals; do not use SI `F&B Complexity Level`. */
  fbComplexity: "F&B Complexity",
  openingTimeline: "Opening Timeline",
};

/** Yes / No / Case-by-Case — mirrors Brand Setup Project Fit. */
export const OAS_YES_NO_CASE_BY_CASE_OPTIONS = ["Yes", "No", "Case-by-Case"];

/** Airtable-canonical program model options (aligned with deal mixed-use intake). */
export const OAS_BRANDED_RESIDENCE_PROGRAM_MODEL_OPTIONS = BRANDED_RESIDENCE_PROGRAM_MODEL_OPTIONS.map(
  (formOpt) => MIXED_USE_SELECT_FORM_TO_AIRTABLE[formOpt] || formOpt
);

export const OAS_CONDO_RENTAL_PROGRAM_MODEL_OPTIONS = CONDO_RENTAL_PROGRAM_MODEL_OPTIONS.map(
  (formOpt) => MIXED_USE_SELECT_FORM_TO_AIRTABLE[formOpt] || formOpt
);

export const OAS_HOA_CONDO_INTERFACE_OPTIONS = [
  "None",
  "Basic",
  "Structured",
  "Dedicated team",
...
export const OAS_RESIDENCE_SALES_SUPPORT_OPTIONS = [
  "None",
  "Advisory",
...
/** Operator Setup — branded residence field names (Airtable column titles). */
export const OAS_OPERATOR_BRANDED_RESIDENCE_FIELD_NAMES = Object.freeze({
  brandedResidencesAllowed: "Branded Residences Allowed",
  mixedUseAllowed: "Mixed-Use Development Allowed",
  brandedResidenceExperienceLevel: "Branded Residence Experience Level",
  brandedResidenceProgramModelsSupported: "Branded Residence Program Models Supported",
  condoRentalProgramModelsSupported: "Condo Rental Program Models Supported",
  brandedResidencePropertiesManaged: "Branded Residence Properties Managed",
  mixedUseHospitalityExperience: "Mixed-Use Hospitality Experience",
  hoaCondoAssociationInterface: "HOA / Condo Association Interface",
  residenceSalesClosingSupport: "Residence Sales & Closing Support",
  brandedResidenceFitSignal: "Branded Residence Fit Signal",
});
