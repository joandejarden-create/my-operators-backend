...
export const TIER1_BRANDS = [
  ...
  },
  {
    ...
    tagline: "A Fresh Take on Midscale",
    ...
    positioning:
      "Midscale extended-stay with residential suites and in-suite kitchens—Choice's newest core midscale extended-stay platform (2020).",
    developmentModel: "New construction and conversion in extended-stay markets; ready-to-build prototype typically 10–12 months; professional third-party management required.",
    typicalUseCase:
      "Greenfield or conversion extended-stay in employment or suburban corridors where owners want Choice's newest midscale extended-stay prototype versus MainStay or Suburban.",
    scenarios: [
    ...
    footprintEditorial:
      "Introduced in 2020 as Choice's midscale extended-stay brand—the first new core midscale brand in nearly a decade. Choice's extended-stay team includes 70+ dedicated experts with multiple properties open and 65+ under development (Choice brand materials).",
    pipelineStats: "65+ properties under development; multiple U.S. openings cited on choicehotelsdevelopment.com.",
    heroPurpose:
      "Midscale extended-stay comfort—operators who execute weekly-stay billing, kitchen operations, and professional third-party management.",
