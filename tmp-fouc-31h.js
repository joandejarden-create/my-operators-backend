 ...
 * - 31h: nav How It Works → Platform → FAQs → Insights.
 * - 31f: bake hero-fit stack (#h1wrap/#hero-lead/#hero-inner) so CTAs do not flash lower→up.
 */
(function () {
  try {
    var path = (location.pathname || "").replace(/\/+$/, "").toLowerCase() || "/";
    if (path !== "/old-home") return;
    if (window.__ohFoucGate && window.__ohFoucGate >= 202607318) return;
    window.__ohFoucGate = 202607318;
