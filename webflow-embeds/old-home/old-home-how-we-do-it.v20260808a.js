/**
 * Old Home — How We Do It compact one-screen process (v20260808a)
  ...
  try {
    ...
    function buildSection() {
      ...
      return (
        ...
        "</div>" +
        '<h2 class="dealality-process_h2" id="dealality-process-h2">' + t("Turn one hotel opportunity into a clear decision process.", "Convierte Una Oportunidad Hotelera en un Proceso de Decisión Estructurado.") + "</h2>" +
