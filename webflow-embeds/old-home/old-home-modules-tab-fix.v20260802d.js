/**
 * Old Home — Benefits outcomes-only + Spanish eyebrows (v20260802d)
 * Path-gated to /, /es, and /old-home (homepage + Spanish locale).
 * 02d: Spanish Title Case matches EN (lowercase el/la/de/por/para/a/y).
...
(function () {
  try {
    ...
    if (window.__ohModulesTabs >= 202608024) return;
    window.__ohModulesTabs = 202608024;
    ...
    var STYLE_ID = "oh-modules-tabs-02d";
    ...
    function apply() {
      ...
      if (badge && badge.getAttribute("data-oh-benefits") !== "02d") {
        badge.setAttribute("data-oh-benefits", "02d");
