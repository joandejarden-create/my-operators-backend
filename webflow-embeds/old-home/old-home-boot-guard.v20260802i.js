/**
 * Old Home Boot Guard (v20260802i)
 * Path-gated to /, /es, and /old-home (homepage + Spanish locale).
 * 02i: footer-oh 02a — locale OR iframe URLs + Spanish reader chrome.
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 2026080209) return;
    window.__ohBootGuard = 2026080209;
    ...
    [
      ...
      "FOOTER_OH_ASSET_PLACEHOLDER_old-home-footer-oh.v20260802a.js",
