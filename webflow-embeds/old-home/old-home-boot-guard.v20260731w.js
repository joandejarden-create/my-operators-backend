/**
 * Old Home Boot Guard (v20260731w)
 * Path-gated to /old-home. Same as 31u + testimonials v20260731ab (Gustavo tighter zoom v20260731i).
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 202607331) return;
    window.__ohBootGuard = 202607331;
    ...
    [
      ...
      "6a6cbc6952ac452a38cd8d69_dealality-old-home-testimonials.v20260731ab.js",
