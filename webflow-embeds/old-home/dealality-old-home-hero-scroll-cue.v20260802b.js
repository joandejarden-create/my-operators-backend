 ...
 * Pins "See How Dealality Works" / Spanish "Cómo Funciona Dealality" to viewport
...
(function () {
  ...
  try {
    ...
    if (window.__ohHeroScrollCue && window.__ohHeroScrollCue >= 2026080202) return;
    window.__ohHeroScrollCue = 2026080202;
    var CUE_LABEL = isEs ? "Cómo Funciona Dealality" : "See How Dealality Works";
    var CUE_ARIA = isEs
      ? "Cómo Funciona Dealality — ir a la sección Cómo Funciona"
    ...
    function ensureCue() {
      ...
      a.innerHTML =
        '<span class="oh-hero-scroll-cue__label">' + CUE_LABEL + "</span>" +
