/**
 * Old Home testimonials carousel (v20260802c)
...
(function () {
  ...
  try {
    ...
    if (window.__ohTestimonials >= 2026080203) return;
  } catch (ePath) {
    return;
  }
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 2026080203;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 2026080203) return;
