/**
 * Old Home — floating collapsible platform overview video launcher (v20260802b).
 * Lazy-loads <video> only after open. Session dismiss only (sessionStorage).
 * v20260802b: Spanish /es UI copy + Spanish closed captions (audio remains English).
...
(function () {
  ...
  window.__ohPlatformVideoLauncher = 2;
