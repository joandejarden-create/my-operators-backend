/**
 * Old Home — How Dealality Works timeline (v20260812a)
 * Replaces compact process with the approved horizontal timeline + Connected Process CTA.
...
(function () {
  ...
  function buildChart(chart, onSelect) {
    ...
    STEPS.forEach(function (s, i) {
      ...
      if (s.n === "08") {
        loiCheckHtml =
          '<span class="ptm-loi-check" aria-label="LOI intent tracked">' +
  ...
  function mount(host) {
    ...
    track("process_section_view", { section: "how-we-do-it", variant: "timeline-12a" });
  }
