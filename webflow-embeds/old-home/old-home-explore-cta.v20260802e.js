/** v20260802e: break /es MutationObserver loop — only set href when changed; reentrancy lock; narrow rewrite triggers. */
/**
...
(function () {
  try {
    ...
    if (window.__ohExploreCta >= 202608023) return;
    window.__ohExploreCta = 202608023;
