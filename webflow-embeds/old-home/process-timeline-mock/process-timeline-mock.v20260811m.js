/**
 * How Dealality Works timeline mock (v20260811m)
 * Step titles use & for paired actions (Meet & Align, etc.).
 * Does not replace #oh-how-we-do-it.
 */
(function () {
  "use strict";
  var ROOT_ID = "oh-process-timeline-mock";
  var VERSION = "v20260811m";
  ...
  var CSS = [
    ...
    "#" + ROOT_ID + " .ptm-grid{display:grid;grid-template-columns:repeat(8,minmax(0,1fr));grid-template-rows:auto var(--ptm-card-h) var(--ptm-band-h);width:100%;min-width:980px;row-gap:var(--ptm-track-gap)}",
    ...
    "#" + ROOT_ID + " .ptm-col-offline{grid-row:2;padding:0 6px 8px;height:var(--ptm-card-h);min-height:var(--ptm-card-h);display:flex;align-items:stretch;justify-content:center;min-width:0}",
