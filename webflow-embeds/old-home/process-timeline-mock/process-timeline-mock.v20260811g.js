/**
 * How Dealality Works timeline mock (v20260811g)
 * Dual-track timeline + hover detail panel. Larger step card type; no Next Trigger row.
 * Does not replace #oh-how-we-do-it.
 */
(function () {
  "use strict";
  var ROOT_ID = "oh-process-timeline-mock";
  var VERSION = "v20260811g";
  ...
  var CSS = [
    ...
    "#" + ROOT_ID + " .ptm-grid{display:grid;grid-template-columns:repeat(8,minmax(0,1fr));grid-template-rows:auto var(--ptm-card-h) 200px;width:100%;min-width:720px}",
    ...
    "@media (max-width:900px){#" + ROOT_ID + "{padding:44px 1rem 40px}#" + ROOT_ID + " .ptm-eyebrow{flex-wrap:wrap;padding:4px 10px 4px 4px}#" + ROOT_ID + " .ptm-eyebrow-right{white-space:normal;margin:6px 2px 2px 8px}#" + ROOT_ID + "{--ptm-card-h:176px}}"
  ].join("");
