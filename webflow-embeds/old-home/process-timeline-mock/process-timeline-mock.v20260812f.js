/**
 * How Dealality Works timeline mock (v20260812f)
 * Taller steps wrapper; concise legend/hint copy.
 * Does not replace #oh-how-we-do-it.
 */
(function () {
  "use strict";
  var ROOT_ID = "oh-process-timeline-mock";
  var VERSION = "v20260812f";
  var NODE_R = 14;
  ...
  var CSS = [
    ...
    "#" + ROOT_ID + " .ptm-chart{position:relative;width:100%;border-radius:14px;overflow:visible;background:linear-gradient(180deg,rgba(17,27,58,.45),rgba(8,15,37,.72));border:1px solid rgba(255,255,255,.08);padding:24px 10px 80px}",
