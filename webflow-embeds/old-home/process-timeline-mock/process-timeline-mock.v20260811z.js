/**
 * How Dealality Works timeline mock (v20260811z)
 * More clearance under step 08 for LOI Intent Tracked; keep full hover content + bottom-aligned panel.
 * Does not replace #oh-how-we-do-it.
 */
(function () {
  "use strict";
  var ROOT_ID = "oh-process-timeline-mock";
  var VERSION = "v20260811z";
  var NODE_R = 14;
  ...
  var CSS = [
    ...
    "#" + ROOT_ID + " .ptm-chart{position:relative;width:100%;border-radius:14px;overflow:visible;background:linear-gradient(180deg,rgba(17,27,58,.45),rgba(8,15,37,.72));border:1px solid rgba(255,255,255,.08);padding:18px 10px 76px}",
