/**
 * How Dealality Works timeline mock (v20260811y)
 * Full hover content restored; taller bottom-aligned panel (no scrollbar); LOI below step 08.
 * Does not replace #oh-how-we-do-it.
 */
(function () {
  "use strict";
  var ROOT_ID = "oh-process-timeline-mock";
  var VERSION = "v20260811y";
  var NODE_R = 14;
  ...
  var CSS = [
    ...
    "@media (max-width:900px){#" + ROOT_ID + "{padding:44px 1rem 40px;--ptm-card-h:175px;--ptm-path-h:56px}#" + ROOT_ID + " .ptm-eyebrow{flex-wrap:wrap;padding:4px 10px 4px 4px}#" + ROOT_ID + " .ptm-eyebrow-right{white-space:normal;margin:6px 2px 2px 8px}#" + ROOT_ID + " .ptm-detail{width:min(420px,70%);bottom:4px;top:auto}}"
  ].join("");
