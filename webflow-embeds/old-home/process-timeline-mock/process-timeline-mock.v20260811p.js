/**
 * How Dealality Works timeline mock (v20260811p)
 * Flat progress rail above a single row; one-active hover dims the rest.
 * Does not replace #oh-how-we-do-it.
 */
(function () {
  "use strict";
  var ROOT_ID = "oh-process-timeline-mock";
  var VERSION = "v20260811p";
  ...
  var CSS = [
    ...
    "#" + ROOT_ID + " .ptm-path-layer circle.ptm-node{fill:#0d1530;stroke:rgba(232,168,74,.35);stroke-width:3;pointer-events:auto;cursor:pointer;transition:transform .2s var(--ptm-ease),filter .2s,stroke .2s,fill .2s}",
    ...
    "#" + ROOT_ID + " .ptm-path-layer circle.ptm-node.is-active{filter:drop-shadow(0 0 8px rgba(232,168,74,.55));transform-origin:center;transform:scale(1.14);stroke:#F0B86A;stroke-width:3.5}",
