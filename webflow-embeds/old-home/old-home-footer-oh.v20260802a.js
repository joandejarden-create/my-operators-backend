...
window.ohOpenOpportunityReview=function(url,label){
  openReader(url,label||t(t("Explore Your Hotel Opportunity","Explora Tu Oportunidad Hotelera"),"Explora Tu Oportunidad Hotelera"),{loadingText:t("Loading opportunity review…","Cargando revisión de oportunidad…")});
};
if(ctaBtn){
