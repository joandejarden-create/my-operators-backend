 ...
 * v20260802a: /es — localize question titles only; keep Webflow ES answers.
 */
(function () {
  "use strict";
  ...
  try {
    ...
    if (window.__ohFaqs >= 202608021) return;
  } catch (ePath) {
    return;
  }
