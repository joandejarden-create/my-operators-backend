/**
 * Old Home Boot Guard (v20260802d)
...
(function () {
  try {
    ...
    if (window.__ohBootGuard && window.__ohBootGuard >= 2026080203) return;
    window.__ohBootGuard = 2026080203;
    ...
    function dimFooterSoonLink(a, baseLabel) {
      ...
      a.textContent = baseLabel + " - Coming Soon";
    ...
    [
      ...
      "6a6e2be24286560977c4b169_dealality-old-home-hero-scroll-cue.v20260801d.js",
    ].forEach(function (f) {
      ...
      if (f.indexOf("hero-scroll-cue") !== -1) {
        s.setAttribute("data-oh-hero-scroll-cue", "01d");
      }
      head.appendChild(s);
    });
  } catch (e) {
