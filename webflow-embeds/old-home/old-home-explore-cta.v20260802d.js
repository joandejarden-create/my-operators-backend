/** v20260802d: rewrite /es hrefs after DOM ready; force locale OR URL into iframe opener. */
/**
...
(function () {
  try {
    ...
    if (window.__ohExploreCta >= 202608022) return;
    window.__ohExploreCta = 202608022;
