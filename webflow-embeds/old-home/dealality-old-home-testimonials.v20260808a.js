/**
 * Old Home testimonials carousel (v20260808a)
 ...
 * - 02d: /es — Lead Asset Manager → Gerente Principal de Activos
 * - 02e: /es — LATAM polish (deal → acuerdo, trade-offs → compensaciones)
 */
(function () {
  "use strict";
  ...
  try {
    ...
    if (window.__ohTestimonials >= 2026080801) return;
  } catch (ePath) {
    return;
  }
  ...
  var JUSTIN_ALT_ES = "Justin Boutwell, Gerente Principal de Activos";
  var GUSTAVO =
  ...
  var ABOUT_LEAD =
    "Dealality comes from real hotel brand, operator, development, and partner decisions, shaped by work with global brands and senior hospitality leaders.";
  var ABOUT_H2_ES =
    "Creada en torno a cómo realmente ocurren las decisiones hoteleras.";
  var ABOUT_LEAD_ES =
  ...
  var CARDS_EN = [
    {
      quote:
        "Owners had options, but no clear way to compare them. I built Dealality so owners can see what an asset could become, in a confidential process, before they commit.",
      name: "Joan Dejarden",
      title: "Founder",
      img: JOAN,
      alt: JOAN_ALT,
    ...
    {
      quote:
        "Development and operating decisions move faster when the right people are working from the same opportunity. Dealality helps bring those conversations together, keep a project moving toward a workable outcome.",
      name: "Gustavo Sarago",
    ...
    {
      quote:
        "Owners gain more when counsel shapes the path before it is half-chosen. Dealality brings advisors into the workflow early enough to change the outcome, with real alternatives and a clear decision record still intact.",
      name: "Joan Dejarden",
      title: "Founder",
      img: JOAN,
      alt: JOAN_ALT,
  ...
  var CARDS_ES = [
    {
      quote:
        "Los propietarios tenían opciones, pero no una forma clara de compararlas. Creé Dealality para que puedan ver qué puede llegar a ser un activo, en un proceso confidencial, antes de comprometerse.",
      name: "Joan Dejarden",
      title: "Fundador",
      img: JOAN,
      alt: JOAN_ALT_ES,
    ...
    {
      quote:
        "Dealality es la herramienta perfecta para centralizar y agilizar la información, las comunicaciones, las herramientas y los participantes del acuerdo que necesito para evaluar una oportunidad. Crea mejor visibilidad sobre las alternativas, las compensaciones y los temas que merecen mayor atención.",
      name: "Justin Boutwell",
      title: "Gerente Principal de Activos",
      img: JUSTIN,
      alt: JUSTIN_ALT_ES,
    },
    {
      quote:
        "Las decisiones de desarrollo y operación avanzan más rápido cuando las personas correctas trabajan desde la misma oportunidad. Dealality ayuda a reunir esas conversaciones y mantener un proyecto en camino hacia un resultado viable.",
      name: "Gustavo Sarago",
    ...
    {
      quote:
        "Los propietarios ganan más cuando el asesoramiento da forma al camino antes de que esté a medias. Dealality incorpora a los asesores al flujo de trabajo lo bastante temprano para cambiar el resultado, con alternativas reales y un registro claro de la decisión aún intactos.",
      name: "Joan Dejarden",
      title: "Fundador",
      img: JOAN,
      alt: JOAN_ALT_ES,
  ...
  function start(root, viewport, slides, dotsWrap) {
    if (started) return;
    started = true;
    window.__ohTestimonials = 2026080801;
  ...
  function tryBoot() {
    if (started || window.__ohTestimonials >= 2026080801) return;
