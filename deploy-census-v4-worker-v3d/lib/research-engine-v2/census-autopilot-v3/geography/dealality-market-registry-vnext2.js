/**
 * Dealality Market Registry vNext2 — curated secondary / resort Markets.
 * City may equal Market ONLY via explicit entries below (not generic fallback).
 */
export const DEALALITY_MARKET_REGISTRY_VNEXT2_VERSION =
  "dealality-market-registry-vnext2-2026-08-08";

export const EXTRA_DEALALITY_MARKETS_VNEXT2 = Object.freeze([
  {
    country: "Brazil",
    canonical_name: "Chapecó",
    cities: ["chapeco", "chapecó"],
    state_region_coverage: ["Santa Catarina"],
    rationale: "Distinct SC interior hotel market",
  ...
  },
  {
    ...
    rationale: "Serra Gaúcha secondary hotel node",
    class: "NEW_SECONDARY_CITY_MARKET",
    effective_version: "dealality-market-registry-vnext2-2026-08-08",
  },
  {
    ...
    cities: ["joinville"],
    state_region_coverage: ["Santa Catarina"],
    rationale: "Major SC industrial metro",
    class: "NEW_SECONDARY_CITY_MARKET",
    effective_version: "dealality-market-registry-vnext2-2026-08-08",
  },
  {
  ...
  },
  {
    ...
    state_region_coverage: ["São Paulo"],
    rationale: "SP interior industrial hotel demand",
    class: "NEW_SECONDARY_CITY_MARKET",
    effective_version: "dealality-market-registry-vnext2-2026-08-08",
  },
  {
    ...
    rationale: "GO industrial corridor",
    class: "NEW_SECONDARY_CITY_MARKET",
    effective_version: "dealality-market-registry-vnext2-2026-08-08",
  },
  {
  ...
  },
  {
    ...
    rationale: "Bahia leisure coast distinct from Salvador",
...
export const CITY_TO_MARKET_VNEXT2 = Object.freeze({
  "chapeco|brazil": "Chapecó",
  "chapecó|brazil": "Chapecó",
  "farroupilha|brazil": "Farroupilha",
  "joinville|brazil": "Joinville",
  "bauru|brazil": "Bauru",
  "jundiai|brazil": "Jundiaí",
  "jundiaí|brazil": "Jundiaí",
  "anapolis|brazil": "Anápolis",
  "anápolis|brazil": "Anápolis",
  "araraquara|brazil": "Araraquara",
  "presidente prudente|brazil": "Presidente Prudente",
  "rondonopolis|brazil": "Rondonópolis",
  "rondonópolis|brazil": "Rondonópolis",
  "praia do forte|brazil": "Costa do Sauípe / Praia do Forte",
  "costa do sauipe|brazil": "Costa do Sauípe / Praia do Forte",
  "costa do sauípe|brazil": "Costa do Sauípe / Praia do Forte",
  "itacare|brazil": "Costa do Sauípe / Praia do Forte",
  "itacaré|brazil": "Costa do Sauípe / Praia do Forte",
  "santiago del estero|argentina": "Santiago del Estero",
  "villa la angostura|argentina": "Villa La Angostura",
});
