...
1. Review steward pack: `docs/data-intelligence/production-census-peru-mincetur-steward-review-pack.md`
2. Dry-run apply (already gated): `npm run census:peru-mincetur-steward-insert-apply -- --pack <pack.json>`
3. After steward approval only: re-run with `--enable-production-writes` + four confirms
4. Colombia apply remains paused
5. Ownership lane (Owner Name from RUC) remains blocked
