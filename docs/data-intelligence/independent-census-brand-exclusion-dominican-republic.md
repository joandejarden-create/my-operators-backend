...
1. **Dual-lane Census intake** — known brands are **not dropped**; see `dual-lane-census-intake-plan-dominican-republic.md`
2. Wikidata dry-run + evidence attach for promote-ready independents
3. Steward review `steward_possible_branded`
4. Gated promote into Hotel Property Census (Independent lane + known-chain backlog)
5. Optional Webhound only on 10–25 hard residual independents
