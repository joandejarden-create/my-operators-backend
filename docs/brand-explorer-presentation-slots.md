...
| `overview.relative_positioning` | Overview snapshot → **Relative Positioning** | Merged **Body** (or **Title** if body empty). Portfolio ladder vs sibling brands—not **Brand Positioning** on Basics. Example: *Premium flag with IHG enterprise scale—not ultra-luxury, not select-service.* |
