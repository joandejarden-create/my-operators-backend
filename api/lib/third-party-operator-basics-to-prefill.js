...
export const BASICS_AIRTABLE_TO_FORM_KEY = {
  ...
  "Geo EU Existing Rooms": "geo_eu_existing_rooms",
  "Geo EU Pipeline Hotels": "geo_eu_pipeline_hotels",
  "Geo EU Pipeline Rooms": "geo_eu_pipeline_rooms",
  ...
  "Luxury Avg On-Site Staff Per Property": "luxuryAvgStaff",
...
export const BASICS_AIRTABLE_ALIASES_TO_FORM_KEY = {
  ...
  "Location Type Resort": "locationTypeResort",
  "Location Type Airport": "locationTypeAirport",
  /** When Small Metro / Interstate are collapsed into one Footprint column on save. */
  "Location Type Highway": "locationTypeInterstate",
  "Location Type Total": "locationTypeTotal",
