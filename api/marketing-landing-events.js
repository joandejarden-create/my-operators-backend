...
const ALLOWED_EVENTS = new Set([
  ...
  "how_it_works_view",
  "opportunity_review_view",
  "opportunity_review_start",
  "opportunity_review_field_progress",
  "opportunity_review_section_complete",
  "opportunity_review_submit_attempt",
  "opportunity_review_submit_success",
  "opportunity_review_submit_failure",
  "opportunity_review_decision_type",
  "homepage_faq_open",
  "homepage_video_play",
  "secondary_audience_click",
  "signin_click",
  "first_scroll",
  "scroll_depth",
  "section_view",
  ...
  "video_progress",
  "video_complete",
  // Old-home floating platform overview launcher (already live on Webflow)
  "platform_video_launcher_impression",
  "platform_video_launcher_open",
  "platform_video_start",
  "platform_video_25",
